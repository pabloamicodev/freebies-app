"use strict";var PromoEngine=(()=>{var ue=Object.defineProperty;var vt=Object.getOwnPropertyDescriptor;var xt=Object.getOwnPropertyNames;var Ct=Object.prototype.hasOwnProperty;var wt=(t,e)=>{for(var n in e)ue(t,n,{get:e[n],enumerable:!0})},It=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of xt(e))!Ct.call(t,i)&&i!==n&&ue(t,i,{get:()=>e[i],enumerable:!(r=vt(e,i))||r.enumerable});return t};var kt=t=>It(ue({},"__esModule",{value:!0}),t);var nn={};wt(nn,{AbortableRequest:()=>F,AjaxCartAdapter:()=>L,PromoEvents:()=>h,StorefrontApiAdapter:()=>Z,debounce:()=>X,emit:()=>w,initBundleBuilder:()=>ht,initCartDrawerIntegration:()=>je,initFbtWidget:()=>_t,initGiftSlider:()=>ft,initTodayOfferWidget:()=>mt,on:()=>I,publishAnalytics:()=>k});var Ue=Promise.resolve();function Q(t){return new Promise((e,n)=>{Ue=Ue.then(t).then(e,n)})}async function B(t,e){let n=await fetch(t,{...e,headers:{"Content-Type":"application/json",Accept:"application/json",...e?.headers}});if(!n.ok){let r=await n.text();throw new Error(`Cart API error ${n.status}: ${r}`)}return n.json()}var L={async getCart(){return B(`${window.Shopify?.routes?.root??"/"}cart.js`)},async addLines(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/add.js`,{method:"POST",body:JSON.stringify({items:t.map(e=>({id:parseInt(e.variantId.split("/").pop()??e.variantId,10),quantity:e.quantity,properties:e.properties}))})}))},async updateLine(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/change.js`,{method:"POST",body:JSON.stringify({id:t.key,quantity:t.quantity,...t.properties?{properties:t.properties}:{}})}))},async removeLine(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/change.js`,{method:"POST",body:JSON.stringify({id:t.key,quantity:0})}))},async applyDiscountCode(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/update.js`,{method:"POST",body:JSON.stringify({discount:t})}))},async removeDiscountCode(){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/update.js`,{method:"POST",body:JSON.stringify({discount:""})}))}};function X(t,e){let n=null,r=null;function i(...l){r=l,n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,r&&t(...r)},e)}function o(){n!==null&&(clearTimeout(n),n=null)}function a(){o(),r&&t(...r)}return{call:i,cancel:o,flush:a}}var F=class{controller=null;start(){return this.controller&&this.controller.abort("superseded"),this.controller=new AbortController,this.controller.signal}cancel(){this.controller&&(this.controller.abort("cancelled"),this.controller=null)}};var h={CartChanged:"promo-engine:cart-changed",EvaluationRequested:"promo-engine:evaluation-requested",EvaluationCompleted:"promo-engine:evaluation-completed",GiftAutoAdded:"promo-engine:gift-auto-added",GiftAdded:"promo-engine:gift-added",GiftUpdated:"promo-engine:gift-updated",GiftRemoved:"promo-engine:gift-removed",GiftSliderRequested:"promo-engine:gift-slider-requested",GiftSliderClosed:"promo-engine:gift-slider-closed",ProductChanged:"promo-engine:product-changed",CartMessageRender:"promo-engine:cart-message-render",ProgressRerender:"promo-engine:progress-rerender",TodayOfferRender:"promo-engine:today-offer-render",BundleInit:"promo-engine:bundle-init",UpsellInit:"promo-engine:upsell-init",CheckoutPrepare:"promo-engine:checkout-prepare",CartMutationError:"promo-engine:cart-mutation-error",InventoryFailure:"promo-engine:inventory-failure"};function w(t,e){window.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0}))}function I(t,e,n){let r=i=>e(i.detail);return window.addEventListener(t,r,n),()=>window.removeEventListener(t,r)}function k(t,e){typeof window.analytics?.publish=="function"&&window.analytics.publish(t,e)}function fe(t,e,n){for(let r of t.items){if(r.variant_id!==e)continue;if(Object.entries(n).every(([o,a])=>r.properties[o]===a))return r.key}return null}function _e(t,e){return t.items.find(n=>n.properties._promo_engine_line_type==="gift"&&n.properties._promo_engine_offer_id===e)??null}async function me(){let t=await fetch(`${window.Shopify?.routes?.root??"/"}cart.js`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`Cart fetch failed: ${t.status}`);return t.json()}var Et=300,St="/apps/promo-engine/evaluate",Me="promo_engine_session_id",ge=class{config;sessionId;evaluationAbort=new F;debouncedEvaluate;lastCartHash=null;constructor(e){this.config=e,this.sessionId=this.getOrCreateSessionId(),this.debouncedEvaluate=X(this.triggerEvaluation.bind(this),Et)}init(){this.log("Promo Engine initialized",this.config),this.listenForCartChanges(),this.triggerEvaluation()}getOrCreateSessionId(){try{let e=sessionStorage.getItem(Me);return e||(e=crypto.randomUUID(),sessionStorage.setItem(Me,e)),e}catch{return crypto.randomUUID()}}listenForCartChanges(){this.patchFetch(),document.addEventListener("cart:updated",()=>this.debouncedEvaluate.call()),document.addEventListener("cart:refresh",()=>this.debouncedEvaluate.call()),document.addEventListener("theme:cart:open",()=>this.debouncedEvaluate.call()),I(h.CartChanged,()=>this.debouncedEvaluate.call())}patchFetch(){let e=/\/cart\/(add|change|update)(\.js)?(\?|$)/,n=window.fetch.bind(window);window.fetch=async(r,i)=>{let o=typeof r=="string"?r:r instanceof URL?r.href:r.url,l=(i?.method??"GET").toUpperCase()==="POST"&&e.test(o),u=await n(r,i);return l&&u.ok&&(console.info(`[PromoEngine] Cart mutation detected (${o}) \u2014 scheduling evaluation`),this.debouncedEvaluate.call()),u}}async triggerEvaluation(){w(h.EvaluationRequested);let e;try{e=await L.getCart()}catch(d){this.log("Failed to fetch cart",d);return}let n=this.buildCartHash(e);if(n===this.lastCartHash){this.log("Cart unchanged, skipping evaluation");return}console.info("[PromoEngine] Evaluating cart \u2014",e.items.map(d=>`${d.title} \xD7${d.quantity}`).join(", ")||"empty",`| subtotal: $${(e.total_price/100).toFixed(2)}`);let r=this.evaluationAbort.start(),i=window.Shopify,o=i?.currency?.active??this.config.currency,a=i?.currency?.rate,l=a?parseFloat(a):null,u=o&&o!==this.config.currency?{id:o,handle:o.toLowerCase(),currencyCode:o,countryCode:i?.country??null,primaryLocale:i?.locale??this.config.locale,exchangeRate:l&&!isNaN(l)?l:null}:null;try{let d=await fetch(St,{method:"POST",headers:{"Content-Type":"application/json","X-Promo-Shop":this.config.shopDomain,"X-Promo-Key":this.config.publicKey,"X-Promo-Session":this.sessionId},body:JSON.stringify({cart:this.normalizeCart(e),customer:null,market:u,locale:this.config.locale,salesChannel:"online_store",requestedUrl:window.location.href,sessionId:this.sessionId}),signal:r});if(!d.ok){let g=await d.text().catch(()=>"(no body)");throw new Error(`Evaluation failed: ${d.status} \u2014 ${g}`)}let f=await d.json();this.lastCartHash=n;let s=Array.isArray(f.cartActions)?f.cartActions:[];s.length>0?console.info("[PromoEngine] Cart actions to apply:",s.map(g=>`${g.action}(${g.variantId??g.lineKey??""}\xD7${g.quantity??0})`).join(", ")):console.info("[PromoEngine] Evaluation complete \u2014 no cart actions"),await this.applyCartActions(s),w(h.EvaluationCompleted,f)}catch(d){if(d.name==="AbortError"){this.log("Evaluation aborted (superseded by newer request)");return}this.log("Evaluation error",d),w(h.CartMutationError,{error:d.message})}}async applyCartActions(e){for(let n of e)try{switch(n.action){case"add_line":{if(!n.variantId)break;let r=parseInt(n.variantId.split("/").pop()??n.variantId,10);console.info(`[PromoEngine] \u2192 add_line variantId=${n.variantId} qty=${n.quantity??1}`),await L.addLines([{variantId:String(r),quantity:n.quantity??1,properties:n.properties??{}}]),w(h.GiftAutoAdded,{variantId:n.variantId,quantity:n.quantity}),k("promo_engine:gift_auto_added",{variant_id:n.variantId,quantity:n.quantity,session_id:this.sessionId});break}case"update_line":{console.info(`[PromoEngine] \u2192 update_line key=${n.lineKey??"?"} qty=${n.quantity??1}`);let r=await me(),o=(r.items.find(a=>a.key===n.lineKey)??(n.offerId?_e(r,n.offerId):null))?.key??(n.variantId?fe(r,parseInt(n.variantId.split("/").pop()??n.variantId,10),n.properties??{}):null);if(!o)break;n.quantity===0?(await L.removeLine({key:o}),w(h.GiftRemoved,{lineKey:o}),k("promo_engine:gift_removed",{line_key:o,reason:"quantity_correction",session_id:this.sessionId})):(await L.updateLine({key:o,quantity:n.quantity??1,properties:n.properties}),w(h.GiftUpdated,{lineKey:o,quantity:n.quantity}));break}case"remove_line":{console.info(`[PromoEngine] \u2192 remove_line key=${n.lineKey??"?"} reason=${n.reason??"offer_disqualified"}`);let r=await me(),o=(r.items.find(a=>a.key===n.lineKey)??(n.offerId?_e(r,n.offerId):null))?.key??(n.variantId?fe(r,parseInt(n.variantId.split("/").pop()??n.variantId,10),n.properties??{}):null);if(!o)break;await L.removeLine({key:o}),w(h.GiftRemoved,{lineKey:o}),k("promo_engine:gift_removed",{line_key:o,reason:n.reason??"offer_disqualified",session_id:this.sessionId});break}}}catch(r){this.log("Cart action failed",{action:n,error:r}),w(h.CartMutationError,{action:n,error:r.message}),k("promo_engine:cart_mutation_error",{action_type:n.action,error:r.message,session_id:this.sessionId})}}buildCartHash(e){return[...e.items.map(r=>`${r.variant_id}:${r.quantity}`).sort(),e.currency].join("|")}normalizeCart(e){return{token:e.token,id:null,lines:e.items.map(n=>({key:n.key,variantId:`gid://shopify/ProductVariant/${n.variant_id}`,productId:`gid://shopify/Product/${n.product_id}`,quantity:n.quantity,priceCents:n.price,compareAtPriceCents:null,properties:n.properties,requiresSellingPlan:n.requires_selling_plan,sellingPlanId:n.selling_plan_allocation?"has-plan":null,productHandle:n.handle,productTitle:n.title,variantTitle:n.variant_title,vendor:n.vendor,productType:n.product_type,tags:n.tags?n.tags.split(", "):[],collections:[],availableForSale:n.available,inventoryPolicy:n.inventory_policy?.toUpperCase()==="CONTINUE"?"CONTINUE":"DENY",inventoryQuantity:n.inventory_quantity})),subtotalCents:e.total_price,discountCodes:e.discount_codes?.map(n=>n.code)??[],currencyCode:e.currency,totalQuantity:e.item_count}}log(e,...n){this.config.debug&&console.info(`[PromoEngine] ${e}`,...n)}api={refreshCart:()=>this.debouncedEvaluate.flush(),evaluate:()=>this.triggerEvaluation(),prepareCheckout:async()=>{this.debouncedEvaluate.cancel(),w(h.CheckoutPrepare),await this.triggerEvaluation()},on:(e,n)=>I(e,n)}};function Oe(){let t=window.__promoEngineConfig;if(!t){console.warn("[PromoEngine] No config found. Ensure the app embed is enabled in your theme.");return}let e=new ge(t);window.PromoEngine=e.api,e.init()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oe):Oe();function je(t={}){let{quantitySelectors:e=[".cart-count",".cart-item-count","[data-cart-count]"],customCartUpdateEvents:n=[],sectionRenderingEnabled:r=!1}=t,i=["cart:updated","cart:refresh","cart:change","cart-drawer:open","cartDrawer:open","drawer:open","theme:cart:open","turbo:cart-update","rebuy:cart-change","slide-cart:open",...n];for(let d of i)document.addEventListener(d,()=>{w(h.CartChanged)});let o=[];function a(){for(let d of e){let f=document.querySelectorAll(d);for(let s of f)o.includes(s)||(u.observe(s,{childList:!0,subtree:!0,characterData:!0}),o.push(s))}}let l=null,u=new MutationObserver(()=>{l&&clearTimeout(l),l=setTimeout(()=>w(h.CartChanged),300)});a(),new MutationObserver(()=>a()).observe(document.body,{childList:!0,subtree:!1}),r&&I(h.GiftAutoAdded,async()=>{let d=Tt();d.length>0&&await Pt(d)}),i.filter(d=>d.includes("open")).forEach(d=>{document.addEventListener(d,()=>{setTimeout(()=>{w(h.ProgressRerender),w(h.CartMessageRender)},100)})})}function Tt(){let t=document.querySelectorAll("[data-section-id]"),e=[];for(let n of t){let r=n.getAttribute("data-section-id");r&&(r.includes("cart")||r.includes("gift"))&&e.push(r)}return e}async function Pt(t){let e=t.map(n=>`sections[]=${encodeURIComponent(n)}`).join("&");try{let n=await fetch(`/cart?${e}`,{headers:{Accept:"application/json"}});if(!n.ok)return;let r=await n.json();for(let[i,o]of Object.entries(r.sections??{})){let a=document.querySelector(`[data-section-id="${i}"]`);a&&o&&(a.outerHTML=o)}}catch{}}var Z=class{endpoint;token;cartId=null;CART_ID_KEY="promo_engine_cart_id";constructor(e,n){this.endpoint=`https://${e}/api/2026-01/graphql.json`,this.token=n}async gql(e,n){let r=await fetch(this.endpoint,{method:"POST",headers:{"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":this.token},body:JSON.stringify({query:e,variables:n})});if(!r.ok)throw new Error(`Storefront API error: ${r.status}`);let i=await r.json();if(i.errors?.length)throw new Error(i.errors[0].message);return i.data}getStoredCartId(){try{return localStorage.getItem(this.CART_ID_KEY)}catch{return null}}storeCartId(e){try{localStorage.setItem(this.CART_ID_KEY,e)}catch{}}async getOrCreateCart(){let e=this.getStoredCartId();if(e)try{let n=await this.fetchCart(e);if(n)return this.cartId=e,n}catch{}return this.createCart()}async fetchCart(e){return(await this.gql(`query GetCart($cartId: ID!) {
      ...
      }`,{cartId:this.cartId,buyerIdentity:{countryCode:e,...n?{customerAccessToken:n}:{}}})).cartBuyerIdentityUpdate.cart}};var se,C,Fe,At,z,He,Ge,Qe,he,te,W,We,xe,be,ye,Rt,ie={},oe=[],Lt=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,de=Array.isArray;function j(t,e){for(var n in e)t[n]=e[n];return t}function Ce(t){t&&t.parentNode&&t.parentNode.removeChild(t)}function M(t,e,n){var r,i,o,a={};for(o in e)o=="key"?r=e[o]:o=="ref"?i=e[o]:a[o]=e[o];if(arguments.length>2&&(a.children=arguments.length>3?se.call(arguments,2):n),typeof t=="function"&&t.defaultProps!=null)for(o in t.defaultProps)a[o]===void 0&&(a[o]=t.defaultProps[o]);return ne(t,a,r,i,null)}function ne(t,e,n,r,i){var o={type:t,props:e,key:n,ref:r,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:i??++Fe,__i:-1,__u:0};return i==null&&C.vnode!=null&&C.vnode(o),o}function U(t){return t.children}function re(t,e){this.props=t,this.context=e}function G(t,e){if(e==null)return t.__?G(t.__,t.__i+1):null;for(var n;e<t.__k.length;e++)if((n=t.__k[e])!=null&&n.__e!=null)return n.__e;return typeof t.type=="function"?G(t):null}function $t(t){if(t.__P&&t.__d){var e=t.__v,n=e.__e,r=[],i=[],o=j({},e);o.__v=e.__v+1,C.vnode&&C.vnode(o),we(t.__P,o,e,t.__n,t.__P.namespaceURI,32&e.__u?[n]:null,r,n??G(e),!!(32&e.__u),i),o.__v=e.__v,o.__.__k[o.__i]=o,Je(r,o,i),e.__e=e.__=null,o.__e!=n&&Ve(o)}}function Ve(t){if((t=t.__)!=null&&t.__c!=null)return t.__e=t.__c.base=null,t.__k.some(function(e){if(e!=null&&e.__e!=null)return t.__e=t.__c.base=e.__e}),Ve(t)}function ze(t){(!t.__d&&(t.__d=!0)&&z.push(t)&&!ae.__r++||He!=C.debounceRendering)&&((He=C.debounceRendering)||Ge)(ae)}function ae(){try{for(var t,e=1;z.length;)z.length>e&&z.sort(Qe),t=z.shift(),e=z.length,$t(t)}finally{z.length=ae.__r=0}}function Ke(t,e,n,r,i,o,a,l,u,d,f){var s,g,p,x,E,_,b,v=r&&r.__k||oe,R=e.length;for(u=qt(n,e,v,u,R),s=0;s<R;s++)(p=n.__k[s])!=null&&(g=p.__i!=-1&&v[p.__i]||ie,p.__i=s,_=we(t,p,g,i,o,a,l,u,d,f),x=p.__e,p.ref&&g.ref!=p.ref&&(g.ref&&Ie(g.ref,null,p),f.push(p.ref,p.__c||x,p)),E==null&&x!=null&&(E=x),(b=!!(4&p.__u))||g.__k===p.__k?(u=Ye(p,u,t,b),b&&g.__e&&(g.__e=null)):typeof p.type=="function"&&_!==void 0?u=_:x&&(u=x.nextSibling),p.__u&=-7);return n.__e=E,u}function qt(t,e,n,r,i){var o,a,l,u,d,f=n.length,s=f,g=0;for(t.__k=new Array(i),o=0;o<i;o++)(a=e[o])!=null&&typeof a!="boolean"&&typeof a!="function"?(typeof a=="string"||typeof a=="number"||typeof a=="bigint"||a.constructor==String?a=t.__k[o]=ne(null,a,null,null,null):de(a)?a=t.__k[o]=ne(U,{children:a},null,null,null):a.constructor===void 0&&a.__b>0?a=t.__k[o]=ne(a.type,a.props,a.key,a.ref?a.ref:null,a.__v):t.__k[o]=a,u=o+g,a.__=t,a.__b=t.__b+1,l=null,(d=a.__i=Dt(a,n,u,s))!=-1&&(s--,(l=n[d])&&(l.__u|=2)),l==null||l.__v==null?(d==-1&&(i>f?g--:i<f&&g++),typeof a.type!="function"&&(a.__u|=4)):d!=u&&(d==u-1?g--:d==u+1?g++:(d>u?g--:g++,a.__u|=4))):t.__k[o]=null;if(s)for(o=0;o<f;o++)(l=n[o])!=null&&(2&l.__u)==0&&(l.__e==r&&(r=G(l)),Ze(l,l));return r}function Ye(t,e,n,r){var i,o;if(typeof t.type=="function"){for(i=t.__k,o=0;i&&o<i.length;o++)i[o]&&(i[o].__=t,e=Ye(i[o],e,n,r));return e}t.__e!=e&&(r&&(e&&t.type&&!e.parentNode&&(e=G(t)),n.insertBefore(t.__e,e||null)),e=t.__e);do e=e&&e.nextSibling;while(e!=null&&e.nodeType==8);return e}function Dt(t,e,n,r){var i,o,a,l=t.key,u=t.type,d=e[n],f=d!=null&&(2&d.__u)==0;if(d===null&&l==null||f&&l==d.key&&u==d.type)return n;if(r>(f?1:0)){for(i=n-1,o=n+1;i>=0||o<e.length;)if((d=e[a=i>=0?i--:o++])!=null&&(2&d.__u)==0&&l==d.key&&u==d.type)return a}return-1}function Ne(t,e,n){e[0]=="-"?t.setProperty(e,n??""):t[e]=n==null?"":typeof n!="number"||Lt.test(e)?n:n+"px"}function ee(t,e,n,r,i){var o,a;e:if(e=="style")if(typeof n=="string")t.style.cssText=n;else{if(typeof r=="string"&&(t.style.cssText=r=""),r)for(e in r)n&&e in n||Ne(t.style,e,"");if(n)for(e in n)r&&n[e]==r[e]||Ne(t.style,e,n[e])}else if(e[0]=="o"&&e[1]=="n")o=e!=(e=e.replace(We,"$1")),a=e.toLowerCase(),e=a in t||e=="onFocusOut"||e=="onFocusIn"?a.slice(2):e.slice(2),t.l||(t.l={}),t.l[e+o]=n,n?r?n[W]=r[W]:(n[W]=xe,t.addEventListener(e,o?ye:be,o)):t.removeEventListener(e,o?ye:be,o);else{if(i=="http://www.w3.org/2000/svg")e=e.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(e!="width"&&e!="height"&&e!="href"&&e!="list"&&e!="form"&&e!="tabIndex"&&e!="download"&&e!="rowSpan"&&e!="colSpan"&&e!="role"&&e!="popover"&&e in t)try{t[e]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&e[4]!="-"?t.removeAttribute(e):t.setAttribute(e,e=="popover"&&n==1?"":n))}}function Be(t){return function(e){if(this.l){var n=this.l[e.type+t];if(e[te]==null)e[te]=xe++;else if(e[te]<n[W])return;return n(C.event?C.event(e):e)}}}function we(t,e,n,r,i,o,a,l,u,d){var f,s,g,p,x,E,_,b,v,R,D,m,A,$,O,y=e.type;if(e.constructor!==void 0)return null;128&n.__u&&(u=!!(32&n.__u),o=[l=e.__e=n.__e]),(f=C.__b)&&f(e);e:if(typeof y=="function")try{if(b=e.props,v=y.prototype&&y.prototype.render,R=(f=y.contextType)&&r[f.__c],D=f?R?R.props.value:f.__:r,n.__c?_=(s=e.__c=n.__c).__=s.__E:(v?e.__c=s=new y(b,D):(e.__c=s=new re(b,D),s.constructor=y,s.render=Mt),R&&R.sub(s),s.state||(s.state={}),s.__n=r,g=s.__d=!0,s.__h=[],s._sb=[]),v&&s.__s==null&&(s.__s=s.state),v&&y.getDerivedStateFromProps!=null&&(s.__s==s.state&&(s.__s=j({},s.__s)),j(s.__s,y.getDerivedStateFromProps(b,s.__s))),p=s.props,x=s.state,s.__v=e,g)v&&y.getDerivedStateFromProps==null&&s.componentWillMount!=null&&s.componentWillMount(),v&&s.componentDidMount!=null&&s.__h.push(s.componentDidMount);else{if(v&&y.getDerivedStateFromProps==null&&b!==p&&s.componentWillReceiveProps!=null&&s.componentWillReceiveProps(b,D),e.__v==n.__v||!s.__e&&s.shouldComponentUpdate!=null&&s.shouldComponentUpdate(b,s.__s,D)===!1){e.__v!=n.__v&&(s.props=b,s.state=s.__s,s.__d=!1),e.__e=n.__e,e.__k=n.__k,e.__k.some(function(S){S&&(S.__=e)}),oe.push.apply(s.__h,s._sb),s._sb=[],s.__h.length&&a.push(s);break e}s.componentWillUpdate!=null&&s.componentWillUpdate(b,s.__s,D),v&&s.componentDidUpdate!=null&&s.__h.push(function(){s.componentDidUpdate(p,x,E)})}if(s.context=D,s.props=b,s.__P=t,s.__e=!1,m=C.__r,A=0,v)s.state=s.__s,s.__d=!1,m&&m(e),f=s.render(s.props,s.state,s.context),oe.push.apply(s.__h,s._sb),s._sb=[];else do s.__d=!1,m&&m(e),f=s.render(s.props,s.state,s.context),s.state=s.__s;while(s.__d&&++A<25);s.state=s.__s,s.getChildContext!=null&&(r=j(j({},r),s.getChildContext())),v&&!g&&s.getSnapshotBeforeUpdate!=null&&(E=s.getSnapshotBeforeUpdate(p,x)),$=f!=null&&f.type===U&&f.key==null?Xe(f.props.children):f,l=Ke(t,de($)?$:[$],e,n,r,i,o,a,l,u,d),s.base=e.__e,e.__u&=-161,s.__h.length&&a.push(s),_&&(s.__E=s.__=null)}catch(S){if(e.__v=null,u||o!=null)if(S.then){for(e.__u|=u?160:128;l&&l.nodeType==8&&l.nextSibling;)l=l.nextSibling;o[o.indexOf(l)]=null,e.__e=l}else{for(O=o.length;O--;)Ce(o[O]);ve(e)}else e.__e=n.__e,e.__k=n.__k,S.then||ve(e);C.__e(S,e,n)}else o==null&&e.__v==n.__v?(e.__k=n.__k,e.__e=n.__e):l=e.__e=Ut(n.__e,e,n,r,i,o,a,u,d);return(f=C.diffed)&&f(e),128&e.__u?void 0:l}function ve(t){t&&(t.__c&&(t.__c.__e=!0),t.__k&&t.__k.some(ve))}function Je(t,e,n){for(var r=0;r<n.length;r++)Ie(n[r],n[++r],n[++r]);C.__c&&C.__c(e,t),t.some(function(i){try{t=i.__h,i.__h=[],t.some(function(o){o.call(i)})}catch(o){C.__e(o,i.__v)}})}function Xe(t){return typeof t!="object"||t==null||t.__b>0?t:de(t)?t.map(Xe):t.constructor!==void 0?null:j({},t)}function Ut(t,e,n,r,i,o,a,l,u){var d,f,s,g,p,x,E,_=n.props||ie,b=e.props,v=e.type;if(v=="svg"?i="http://www.w3.org/2000/svg":v=="math"?i="http://www.w3.org/1998/Math/MathML":i||(i="http://www.w3.org/1999/xhtml"),o!=null){for(d=0;d<o.length;d++)if((p=o[d])&&"setAttribute"in p==!!v&&(v?p.localName==v:p.nodeType==3)){t=p,o[d]=null;break}}if(t==null){if(v==null)return document.createTextNode(b);t=document.createElementNS(i,v,b.is&&b),l&&(C.__m&&C.__m(e,o),l=!1),o=null}if(v==null)_===b||l&&t.data==b||(t.data=b);else{if(o=v=="textarea"&&b.defaultValue!=null?null:o&&se.call(t.childNodes),!l&&o!=null)for(_={},d=0;d<t.attributes.length;d++)_[(p=t.attributes[d]).name]=p.value;for(d in _)p=_[d],d=="dangerouslySetInnerHTML"?s=p:d=="children"||d in b||d=="value"&&"defaultValue"in b||d=="checked"&&"defaultChecked"in b||ee(t,d,null,p,i);for(d in b)p=b[d],d=="children"?g=p:d=="dangerouslySetInnerHTML"?f=p:d=="value"?x=p:d=="checked"?E=p:l&&typeof p!="function"||_[d]===p||ee(t,d,p,_[d],i);if(f)l||s&&(f.__html==s.__html||f.__html==t.innerHTML)||(t.innerHTML=f.__html),e.__k=[];else if(s&&(t.innerHTML=""),Ke(e.type=="template"?t.content:t,de(g)?g:[g],e,n,r,v=="foreignObject"?"http://www.w3.org/1999/xhtml":i,o,a,o?o[0]:n.__k&&G(n,0),l,u),o!=null)for(d=o.length;d--;)Ce(o[d]);l&&v!="textarea"||(d="value",v=="progress"&&x==null?t.removeAttribute("value"):x!=null&&(x!==t[d]||v=="progress"&&!x||v=="option"&&x!=_[d])&&ee(t,d,x,_[d],i),d="checked",E!=null&&E!=t[d]&&ee(t,d,E,_[d],i))}return t}function Ie(t,e,n){try{if(typeof t=="function"){var r=typeof t.__u=="function";r&&t.__u(),r&&e==null||(t.__u=t(e))}else t.current=e}catch(i){C.__e(i,n)}}function Ze(t,e,n){var r,i;if(C.unmount&&C.unmount(t),(r=t.ref)&&(r.current&&r.current!=t.__e||Ie(r,null,e)),(r=t.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(o){C.__e(o,e)}r.base=r.__P=null}if(r=t.__k)for(i=0;i<r.length;i++)r[i]&&Ze(r[i],e,n||typeof t.type!="function");n||Ce(t.__e),t.__c=t.__=t.__e=void 0}function Mt(t,e,n){return this.constructor(t,n)}function H(t,e,n){var r,i,o,a;e==document&&(e=document.documentElement),C.__&&C.__(t,e),i=(r=typeof n=="function")?null:n&&n.__k||e.__k,o=[],a=[],we(e,t=(!r&&n||e).__k=M(U,null,[t]),i||ie,ie,e.namespaceURI,!r&&n?[n]:i?null:e.firstChild?se.call(e.childNodes):null,o,!r&&n?n:i?i.__e:e.firstChild,r,a),Je(o,t,a)}se=oe.slice,C={__e:function(t,e,n,r){for(var i,o,a;e=e.__;)if((i=e.__c)&&!i.__)try{if((o=i.constructor)&&o.getDerivedStateFromError!=null&&(i.setState(o.getDerivedStateFromError(t)),a=i.__d),i.componentDidCatch!=null&&(i.componentDidCatch(t,r||{}),a=i.__d),a)return i.__E=i}catch(l){t=l}throw t}},Fe=0,At=function(t){return t!=null&&t.constructor===void 0},re.prototype.setState=function(t,e){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=j({},this.state),typeof t=="function"&&(t=t(j({},n),this.props)),t&&j(n,t),t!=null&&this.__v&&(e&&this._sb.push(e),ze(this))},re.prototype.forceUpdate=function(t){this.__v&&(this.__e=!0,t&&this.__h.push(t),ze(this))},re.prototype.render=U,z=[],Ge=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Qe=function(t,e){return t.__v.__b-e.__v.__b},ae.__r=0,he=Math.random().toString(8),te="__d"+he,W="__a"+he,We=/(PointerCapture)$|Capture$/i,xe=0,be=Be(!1),ye=Be(!0),Rt=0;var V,T,ke,et,Ee=0,dt=[],P=C,tt=P.__b,nt=P.__r,rt=P.diffed,it=P.__c,ot=P.unmount,at=P.__;function Te(t,e){P.__h&&P.__h(T,t,Ee||e),Ee=0;var n=T.__H||(T.__H={__:[],__h:[]});return t>=n.__.length&&n.__.push({}),n.__[t]}function q(t){return Ee=1,Ot(pt,t)}function Ot(t,e,n){var r=Te(V++,2);if(r.t=t,!r.__c&&(r.__=[n?n(e):pt(void 0,e),function(l){var u=r.__N?r.__N[0]:r.__[0],d=r.t(u,l);u!==d&&(r.__N=[d,r.__[1]],r.__c.setState({}))}],r.__c=T,!T.__f)){var i=function(l,u,d){if(!r.__c.__H)return!0;var f=r.__c.__H.__.filter(function(g){return g.__c});if(f.every(function(g){return!g.__N}))return!o||o.call(this,l,u,d);var s=r.__c.props!==l;return f.some(function(g){if(g.__N){var p=g.__[0];g.__=g.__N,g.__N=void 0,p!==g.__[0]&&(s=!0)}}),o&&o.call(this,l,u,d)||s};T.__f=!0;var o=T.shouldComponentUpdate,a=T.componentWillUpdate;T.componentWillUpdate=function(l,u,d){if(this.__e){var f=o;o=void 0,i(l,u,d),o=f}a&&a.call(this,l,u,d)},T.shouldComponentUpdate=i}return r.__N||r.__}function ce(t,e){var n=Te(V++,3);!P.__s&&ct(n.__H,e)&&(n.__=t,n.u=e,T.__H.__h.push(n))}function lt(t,e){var n=Te(V++,7);return ct(n.__H,e)&&(n.__=t(),n.__H=e,n.__h=t),n.__}function jt(){for(var t;t=dt.shift();){var e=t.__H;if(t.__P&&e)try{e.__h.some(le),e.__h.some(Se),e.__h=[]}catch(n){e.__h=[],P.__e(n,t.__v)}}}P.__b=function(t){T=null,tt&&tt(t)},P.__=function(t,e){t&&e.__k&&e.__k.__m&&(t.__m=e.__k.__m),at&&at(t,e)},P.__r=function(t){nt&&nt(t),V=0;var e=(T=t.__c).__H;e&&(ke===T?(e.__h=[],T.__h=[],e.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(e.__h.some(le),e.__h.some(Se),e.__h=[],V=0)),ke=T},P.diffed=function(t){rt&&rt(t);var e=t.__c;e&&e.__H&&(e.__H.__h.length&&(dt.push(e)!==1&&et===P.requestAnimationFrame||((et=P.requestAnimationFrame)||Ht)(jt)),e.__H.__.some(function(n){n.u&&(n.__H=n.u),n.u=void 0})),ke=T=null},P.__c=function(t,e){e.some(function(n){try{n.__h.some(le),n.__h=n.__h.filter(function(r){return!r.__||Se(r)})}catch(r){e.some(function(i){i.__h&&(i.__h=[])}),e=[],P.__e(r,n.__v)}}),it&&it(t,e)},P.unmount=function(t){ot&&ot(t);var e,n=t.__c;n&&n.__H&&(n.__H.__.some(function(r){try{le(r)}catch(i){e=i}}),n.__H=void 0,e&&P.__e(e,n.__v))};var st=typeof requestAnimationFrame=="function";function Ht(t){var e,n=function(){clearTimeout(r),st&&cancelAnimationFrame(e),setTimeout(t)},r=setTimeout(n,35);st&&(e=requestAnimationFrame(n))}function le(t){var e=T,n=t.__c;typeof n=="function"&&(t.__c=void 0,n()),T=e}function Se(t){var e=T;t.__c=t.__(),T=e}function ct(t,e){return!t||t.length!==e.length||e.some(function(n,r){return n!==t[r]})}function pt(t,e){return typeof e=="function"?e(t):e}var zt=0;function c(t,e,n,r,i,o){e||(e={});var a,l,u=e;if("ref"in u)for(l in u={},e)l=="ref"?a=e[l]:u[l]=e[l];var d={type:t,props:u,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--zt,__i:-1,__u:0,__source:i,__self:o};if(typeof t=="function"&&(a=t.defaultProps))for(l in a)u[l]===void 0&&(u[l]=a[l]);return C.vnode&&C.vnode(d),d}var Nt=`
.pe-slider-overlay {
...
`;function Bt(){if(document.getElementById("pe-slider-styles"))return;let t=document.createElement("style");t.id="pe-slider-styles",t.textContent=Nt,document.head.appendChild(t)}function Ft({payload:t,sessionId:e,onClose:n,onConfirm:r}){let[i,o]=q(new Set(t.selectableGifts.filter(p=>p.isSelected).map(p=>p.variantId))),[a,l]=q(!1),u=t.maxSelectableCount-t.alreadySelectedCount,d=i.size<u;function f(p){if(!p.isAvailable)return;let x=new Set(i);x.has(p.variantId)?x.delete(p.variantId):d&&x.add(p.variantId),o(x)}async function s(){l(!0);try{await r([...i]),k("promo_engine:gift_selected",{offer_id:t.offerId,variant_ids:[...i],session_id:e}),n()}finally{l(!1)}}function g(p){p.target.classList.contains("pe-slider-overlay")&&n()}return ce(()=>{let p=x=>{x.key==="Escape"&&n()};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[n]),c("div",{class:"pe-slider-overlay",onClick:g,role:"dialog","aria-modal":"true",children:c("div",{class:"pe-slider-modal",children:[c("div",{class:"pe-slider-header",children:[c("div",{children:[c("h2",{class:"pe-slider-title",children:t.title}),t.subtitle&&c("p",{class:"pe-slider-subtitle",children:t.subtitle})]}),c("button",{class:"pe-slider-close",onClick:n,"aria-label":"Close gift selection",children:"\u2715"})]}),c("div",{class:"pe-slider-body",children:c("div",{class:"pe-gift-grid",children:t.selectableGifts.map(p=>{let x=i.has(p.variantId),E=!p.isAvailable;return c("div",{class:`pe-gift-card${x?" pe-selected":""}${E?" pe-unavailable":""}`,onClick:()=>f(p),role:"checkbox","aria-checked":x,"aria-disabled":E,tabIndex:E?-1:0,onKeyDown:_=>{(_.key==="Enter"||_.key===" ")&&(_.preventDefault(),f(p))},children:[x&&c("span",{class:"pe-gift-check","aria-hidden":"true",children:"\u2713"}),p.imageUrl?c("img",{class:"pe-gift-img",src:p.imageUrl,alt:p.title,loading:"lazy",width:160,height:160}):c("div",{class:"pe-gift-img-placeholder","aria-hidden":"true"}),c("p",{class:"pe-gift-name",children:p.title}),p.variantTitle&&c("p",{class:"pe-gift-variant",children:p.variantTitle}),c("p",{class:"pe-gift-price",children:p.discountedPriceCents===0?c("span",{class:"pe-gift-free",children:"Free"}):c(U,{children:[c("s",{children:["$",(p.originalPriceCents/100).toFixed(2)]})," ",c("span",{class:"pe-gift-free",children:["$",(p.discountedPriceCents/100).toFixed(2)]})]})}),E&&c("p",{style:{fontSize:"11px",color:"#ef4444",marginTop:"4px"},children:"Out of stock"})]},p.variantId)})})}),c("div",{class:"pe-slider-footer",children:[c("p",{class:"pe-selected-count",children:[i.size," / ",u," selected"]}),c("button",{class:"pe-btn-confirm",onClick:s,disabled:i.size===0||a,children:a?c("span",{class:"pe-spinner",style:{display:"inline-block"}}):`Add ${i.size>0?i.size:""} Gift${i.size!==1?"s":""} to Cart`})]})]})})}var N=null;function ut(t,e){Bt(),N||(N=document.createElement("div"),N.id="pe-gift-slider-root",document.body.appendChild(N)),H(M(Ft,{payload:t,sessionId:e,onClose:()=>{N&&(H(M(U,null),N),w(h.GiftSliderClosed),k("promo_engine:gift_slider_opened",{offer_id:t.offerId,session_id:e}))},onConfirm:async i=>{let a=(await L.getCart()).items.filter(l=>l.properties._promo_engine_offer_id===t.offerId);for(let l of a)i.includes(String(l.variant_id))||await L.removeLine({key:l.key});for(let l of i)if(!a.some(d=>String(d.variant_id)===l)){let d=t.selectableGifts.find(f=>f.variantId===l);await L.addLines([{variantId:l,quantity:1,properties:{_promo_engine_line_type:"gift",_promo_engine_offer_id:t.offerId,_promo_engine_reward_id:d?.variantId??l,_promo_engine_offer_version:"1",_promo_engine_hash:""}}])}w(h.CartChanged)}}),N),k("promo_engine:gift_slider_opened",{offer_id:t.offerId,session_id:e})}function ft(t){I(h.EvaluationCompleted,e=>{e.giftSlider&&Array.isArray(e.giftSlider.selectableGifts)&&ut(e.giftSlider,t)}),I(h.GiftSliderRequested,e=>{ut(e,t)})}var Gt=`
...
`;function K(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Qt({config:t,currency:e,sessionId:n}){let[r,i]=q(new Set([t.mainProduct.variantId,...t.relatedProducts.slice(0,2).map(_=>_.variantId)])),[o,a]=q(!1),[l,u]=q(!1),d=[t.mainProduct,...t.relatedProducts.slice(0,t.maxProducts-1)],f=d.filter(_=>r.has(_.variantId)),s=f.reduce((_,b)=>_+b.discountedPriceCents,0),p=f.reduce((_,b)=>_+b.priceCents,0)-s;function x(_){if(_===t.mainProduct.variantId)return;let b=new Set(r);b.has(_)?b.delete(_):b.add(_),i(b)}async function E(){if(!(o||f.length===0)){a(!0);try{await L.addLines(f.map(_=>({variantId:_.variantId,quantity:1,properties:{_promo_engine_line_type:"upsell",_promo_engine_offer_id:t.offerId}}))),u(!0),w(h.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,widget_type:"fbt",variant_ids:[...r],session_id:n})}finally{a(!1)}}}return ce(()=>{k("promo_engine:widget_viewed",{offer_id:t.offerId,widget_type:"fbt",session_id:n})},[]),l?c("div",{class:"pe-fbt",children:c("p",{class:"pe-fbt-added",children:["\u2713 Added ",f.length," item(s) to cart!"]})}):c("div",{class:"pe-fbt",children:[c("h3",{class:"pe-fbt-title",children:t.title||"Frequently Bought Together"}),c("div",{class:"pe-fbt-products",children:d.map((_,b)=>{let v=r.has(_.variantId),R=_.variantId===t.mainProduct.variantId;return c(U,{children:[b>0&&c("span",{class:"pe-fbt-plus","aria-hidden":"true",children:"+"}),c("div",{class:`pe-fbt-product${v?" pe-selected":""}`,onClick:()=>x(_.variantId),role:"checkbox","aria-checked":v,tabIndex:R?-1:0,onKeyDown:D=>{(D.key===" "||D.key==="Enter")&&(D.preventDefault(),x(_.variantId))},children:[c("input",{type:"checkbox",class:"pe-fbt-check",checked:v,disabled:R,"aria-hidden":"true",tabIndex:-1,readOnly:!0}),_.imageUrl?c("img",{class:"pe-fbt-img",src:_.imageUrl,alt:_.title,loading:"lazy"}):c("div",{class:"pe-fbt-img-ph","aria-hidden":"true"}),c("div",{class:"pe-fbt-info",children:[c("p",{class:"pe-fbt-name",children:_.title}),_.variantTitle&&c("p",{class:"pe-fbt-price",children:_.variantTitle}),c("p",{class:"pe-fbt-price",children:_.discountedPriceCents<_.priceCents?c("span",{class:"pe-fbt-price-disc",children:K(_.discountedPriceCents,e)}):K(_.priceCents,e)})]})]},_.variantId)]})})}),c("div",{class:"pe-fbt-summary",children:[c("p",{class:"pe-fbt-total",children:["Total: ",c("strong",{children:K(s,e)}),p>0&&c(U,{children:[" ",c("span",{class:"pe-fbt-price-disc",children:["(save ",K(p,e),")"]})]})]}),c("button",{class:"pe-fbt-btn",onClick:E,disabled:o||f.length===0,"aria-label":`Add ${f.length} item(s) to cart for ${K(s,e)}`,children:o?"Adding\u2026":t.buttonText||`Add ${f.length} to Cart`})]})]})}function _t(t,e,n,r){if(!document.getElementById("pe-fbt-styles")){let i=document.createElement("style");i.id="pe-fbt-styles",i.textContent=Gt,document.head.appendChild(i)}H(M(Qt,{config:e,currency:n,sessionId:r}),t)}var Wt={position:"bottom_right",style:"icon_title",primaryColor:"#111",iconSizeRem:3.5},Vt=`
.pe-today-wrap {
...
`;function Kt({items:t,config:e,sessionId:n}){let[r,i]=q(!1);if(t.length===0)return null;let o=e.position==="bottom_left"?"pe-left":"pe-right";function a(l){if(k("promo_engine:widget_clicked",{offer_id:l.offerId,widget_type:"today_offer",session_id:n}),l.redirectUrl)try{let u=new URL(l.redirectUrl,window.location.href);if(u.protocol==="http:"||u.protocol==="https:"){window.location.href=u.href;return}}catch{}i(!1)}return c("div",{class:`pe-today-wrap ${o}`,style:{"--pe-primary":e.primaryColor},children:[r&&c("div",{class:"pe-today-panel",role:"dialog","aria-label":"Today's offers",children:[c("div",{class:"pe-today-panel-header",children:[c("h3",{class:"pe-today-panel-title",children:"Today's Offers"}),c("button",{class:"pe-today-close",onClick:()=>i(!1),"aria-label":"Close",children:"\u2715"})]}),c("div",{class:"pe-today-offers",children:t.map(l=>c("div",{class:"pe-today-offer-item",onClick:()=>a(l),role:"button",tabIndex:0,onKeyDown:u=>{u.key==="Enter"&&a(l)},children:[l.imageUrl?c("img",{class:"pe-today-offer-img",src:l.imageUrl,alt:l.title,loading:"lazy"}):c("div",{class:"pe-today-offer-img","aria-hidden":"true",children:"\u{1F381}"}),c("div",{class:"pe-today-offer-info",children:[c("p",{class:"pe-today-offer-title",children:l.title}),l.description&&c("p",{class:"pe-today-offer-desc",children:l.description})]}),c("span",{class:"pe-today-offer-btn",children:l.buttonText||"View \u2192"})]},l.offerId))})]}),c("button",{class:"pe-today-trigger",onClick:()=>{i(l=>!l),r||k("promo_engine:widget_viewed",{widget_type:"today_offer",offer_count:t.length,session_id:n})},"aria-expanded":r,"aria-haspopup":"dialog","aria-label":`${t.length} offer${t.length!==1?"s":""} available`,children:[c("span",{class:"pe-today-icon","aria-hidden":"true",children:"\u{1F381}"}),e.style==="icon_title"&&c("span",{children:"Today's Deals"}),c("span",{class:"pe-today-dot","aria-hidden":"true"})]})]})}var Y=null;function mt(t,e){let n={...Wt,...t};if(!document.getElementById("pe-today-styles")){let r=document.createElement("style");r.id="pe-today-styles",r.textContent=Vt,document.head.appendChild(r)}Y||(Y=document.createElement("div"),Y.id="pe-today-offer-root",document.body.appendChild(Y)),I(h.EvaluationCompleted,r=>{let i=(Array.isArray(r.qualifiedOffers)?r.qualifiedOffers:[]).map(o=>({offerId:o.offerId,title:o.type+" offer",description:"",imageUrl:null,buttonText:"View",redirectUrl:null,badgeText:null}));H(M(Kt,{items:i,config:n,sessionId:e}),Y)})}function gt(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Yt(t,e){return[...e].sort((n,r)=>r.minQuantity-n.minQuantity).find(n=>t>=n.minQuantity)??null}function Jt({config:t,sessionId:e}){let[n,r]=q(0),[i,o]=q(new Map),[a,l]=q(""),u="name_asc",[d,f]=q(!1),[s,g]=q(!1),p=t.layoutMode==="one_step_per_page",x=p?[t.steps[n]].filter(Boolean):t.steps,E=lt(()=>{let m=0;for(let A of i.values())for(let $ of A.values())m+=$;return m},[i]),_=Yt(E,t.tiers);function b(m,A,$){o(O=>{let y=new Map(O),S=new Map(y.get(m)??[]);return $===0?S.delete(A):S.set(A,$),y.set(m,S),y})}function v(m){return[...i.get(m)?.values()??[]].reduce((A,$)=>A+$,0)}function R(m){let A=v(m.id);return A>=m.minQuantity&&(m.maxQuantity===null||A<=m.maxQuantity)}async function D(){if(!d){f(!0);try{let m=[];for(let[A,$]of i.entries())for(let[O,y]of $.entries())m.push({variantId:O,quantity:y,properties:{_promo_engine_line_type:"bundle_component",_promo_engine_offer_id:t.offerId,_promo_engine_bundle_id:t.bundleId,_promo_engine_bundle_step_id:A,_promo_engine_bundle_title:t.title,_promo_engine_hash:""}});await L.addLines(m),g(!0),w(h.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,bundle_id:t.bundleId,total_qty:E,session_id:e})}finally{f(!1)}}}return s?c("div",{class:"pe-bb-success",children:[c("p",{children:"\u2713 Bundle added to cart!"}),c("button",{onClick:()=>g(!1),children:"Build Another"})]}):c("div",{class:"pe-bb",children:[c("h1",{class:"pe-bb-title",children:t.title}),t.description&&c("p",{class:"pe-bb-desc",children:t.description}),t.tiers.length>0&&c("div",{class:"pe-bb-tiers",children:t.tiers.map(m=>c("div",{class:`pe-bb-tier${_?.minQuantity===m.minQuantity?" pe-active":""}`,children:[c("span",{class:"pe-bb-tier-label",children:m.label}),c("span",{class:"pe-bb-tier-qty",children:["Buy ",m.minQuantity,"+"]}),c("span",{class:"pe-bb-tier-discount",children:m.discountType==="percentage"?`-${Math.round(m.discountValue)}%`:gt(m.discountValue,t.currency)})]},m.minQuantity))}),x.map(m=>{let A=v(m.id),$=R(m),O=m.products.filter(y=>!a||y.title.toLowerCase().includes(a.toLowerCase())).sort((y,S)=>u==="price_asc"?y.priceCents-S.priceCents:u==="price_desc"?S.priceCents-y.priceCents:y.title.localeCompare(S.title));return c("div",{class:"pe-bb-step",children:[c("div",{class:"pe-bb-step-header",children:[c("h2",{class:"pe-bb-step-title",children:[p&&`Step ${n+1} of ${t.steps.length}: `,m.title]}),m.subtitle&&c("p",{class:"pe-bb-step-subtitle",children:m.subtitle}),c("p",{class:"pe-bb-step-count",children:[A," selected",m.minQuantity>0&&` (min ${m.minQuantity})`,m.maxQuantity&&` (max ${m.maxQuantity})`,$&&" \u2713"]})]}),m.searchEnabled&&c("input",{class:"pe-bb-search",type:"text",placeholder:"Search products...",value:a,onInput:y=>l(y.target.value),"aria-label":"Search products in this step"}),c("div",{class:"pe-bb-products",children:O.map(y=>{let S=i.get(m.id)?.get(y.variantId)??0,De=m.maxQuantity!==null&&A>=m.maxQuantity&&S===0;return c("div",{class:`pe-bb-product${S>0?" pe-selected":""}${y.isAvailable?"":" pe-unavailable"}${De?" pe-at-max":""}`,children:[y.imageUrl&&c("img",{class:"pe-bb-img",src:y.imageUrl,alt:y.title,loading:"lazy"}),c("p",{class:"pe-bb-product-name",children:y.title}),y.variantTitle&&c("p",{class:"pe-bb-variant",children:y.variantTitle}),c("p",{class:"pe-bb-price",children:gt(y.priceCents,t.currency)}),y.isAvailable?c("div",{class:"pe-bb-qty-ctrl",children:[c("button",{onClick:()=>b(m.id,y.variantId,Math.max(0,S-1)),disabled:S===0,"aria-label":`Remove ${y.title}`,children:"\u2212"}),c("span",{class:"pe-bb-qty",children:S}),c("button",{onClick:()=>b(m.id,y.variantId,S+1),disabled:De,"aria-label":`Add ${y.title}`,children:"+"})]}):c("span",{class:"pe-bb-oos",children:"Out of stock"})]},y.variantId)})})]},m.id)}),c("div",{class:"pe-bb-footer",children:p?c("div",{class:"pe-bb-nav",children:[n>0&&c("button",{class:"pe-bb-btn-prev",onClick:()=>r(m=>m-1),children:"\u2190 Previous"}),n<t.steps.length-1?c("button",{class:"pe-bb-btn-next",onClick:()=>{k("promo_engine:bundle_step_completed",{offer_id:t.offerId,step_index:n,session_id:e}),r(m=>m+1)},disabled:!t.steps[n]||!R(t.steps[n]),children:"Next \u2192"}):c("button",{class:"pe-bb-btn-add",onClick:D,disabled:d||!t.steps.every(m=>R(m)),children:d?"Adding\u2026":`Add Bundle to Cart${_?` (${_.label})`:""}`})]}):c("div",{class:"pe-bb-summary",children:[c("p",{class:"pe-bb-total",children:[E," items selected"]}),_&&c("p",{class:"pe-bb-saving",children:["\u{1F4B0} ",_.label," applied!"]}),c("button",{class:"pe-bb-btn-add",onClick:D,disabled:d||!t.steps.every(m=>R(m)),children:d?"Adding\u2026":"Add Bundle to Cart"})]})})]})}function ht(t,e,n){H(M(Jt,{config:e,sessionId:n}),t)}var Pe=class extends HTMLElement{offerId="";widgetId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.widgetId=this.getAttribute("widget-id")??"",this.attachShadow({mode:"open"}),this.renderSkeleton(),this.unsubscribe=I(h.EvaluationCompleted,e=>{let n=(Array.isArray(e.progressBars)?e.progressBars:[]).find(r=>r.offerId===this.offerId||r.widgetId===this.widgetId);n&&this.renderPayload(n)})}disconnectedCallback(){this.unsubscribe?.()}renderSkeleton(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
