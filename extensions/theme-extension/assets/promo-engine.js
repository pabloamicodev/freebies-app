...
`;function K(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Qt({config:t,currency:e,sessionId:n}){let[r,i]=q(new Set([t.mainProduct.variantId,...t.relatedProducts.slice(0,2).map(m=>m.variantId)])),[o,a]=q(!1),[d,u]=q(!1),l=[t.mainProduct,...t.relatedProducts.slice(0,t.maxProducts-1)],f=l.filter(m=>r.has(m.variantId)),s=f.reduce((m,b)=>m+b.discountedPriceCents,0),p=f.reduce((m,b)=>m+b.priceCents,0)-s;function x(m){if(m===t.mainProduct.variantId)return;let b=new Set(r);b.has(m)?b.delete(m):b.add(m),i(b)}async function E(){if(!(o||f.length===0)){a(!0);try{await $.addLines(f.map(m=>({variantId:m.variantId,quantity:1,properties:{_promo_engine_line_type:"upsell",_promo_engine_offer_id:t.offerId}}))),u(!0),w(g.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,widget_type:"fbt",variant_ids:[...r],session_id:n})}finally{a(!1)}}}return ce(()=>{k("promo_engine:widget_viewed",{offer_id:t.offerId,widget_type:"fbt",session_id:n})},[]),d?c("div",{class:"pe-fbt",children:c("p",{class:"pe-fbt-added",children:["\u2713 Added ",f.length," item(s) to cart!"]})}):c("div",{class:"pe-fbt",children:[c("h3",{class:"pe-fbt-title",children:t.title||"Frequently Bought Together"}),c("div",{class:"pe-fbt-products",children:l.map((m,b)=>{let v=r.has(m.variantId),R=m.variantId===t.mainProduct.variantId;return c(U,{children:[b>0&&c("span",{class:"pe-fbt-plus","aria-hidden":"true",children:"+"}),c("div",{class:`pe-fbt-product${v?" pe-selected":""}`,onClick:()=>x(m.variantId),role:"checkbox","aria-checked":v,tabIndex:R?-1:0,onKeyDown:D=>{(D.key===" "||D.key==="Enter")&&(D.preventDefault(),x(m.variantId))},children:[c("input",{type:"checkbox",class:"pe-fbt-check",checked:v,disabled:R,"aria-hidden":"true",tabIndex:-1,readOnly:!0}),m.imageUrl?c("img",{class:"pe-fbt-img",src:m.imageUrl,alt:m.title,loading:"lazy"}):c("div",{class:"pe-fbt-img-ph","aria-hidden":"true"}),c("div",{class:"pe-fbt-info",children:[c("p",{class:"pe-fbt-name",children:m.title}),m.variantTitle&&c("p",{class:"pe-fbt-price",children:m.variantTitle}),c("p",{class:"pe-fbt-price",children:m.discountedPriceCents<m.priceCents?c("span",{class:"pe-fbt-price-disc",children:K(m.discountedPriceCents,e)}):K(m.priceCents,e)})]})]},m.variantId)]})})}),c("div",{class:"pe-fbt-summary",children:[c("p",{class:"pe-fbt-total",children:["Total: ",c("strong",{children:K(s,e)}),p>0&&c(U,{children:[" ",c("span",{class:"pe-fbt-price-disc",children:["(save ",K(p,e),")"]})]})]}),c("button",{class:"pe-fbt-btn",onClick:E,disabled:o||f.length===0,"aria-label":`Add ${f.length} item(s) to cart for ${K(s,e)}`,children:o?"Adding\u2026":t.buttonText||`Add ${f.length} to Cart`})]})]})}function mt(t,e,n,r){if(!document.getElementById("pe-fbt-styles")){let i=document.createElement("style");i.id="pe-fbt-styles",i.textContent=Gt,document.head.appendChild(i)}H(M(Qt,{config:e,currency:n,sessionId:r}),t)}var Wt={position:"bottom_right",style:"icon_title",primaryColor:"#111",iconSizeRem:3.5},Vt=`
.pe-today-wrap {
...
`;function Kt({items:t,config:e,sessionId:n}){let[r,i]=q(!1);if(t.length===0)return null;let o=e.position==="bottom_left"?"pe-left":"pe-right";function a(d){if(k("promo_engine:widget_clicked",{offer_id:d.offerId,widget_type:"today_offer",session_id:n}),d.redirectUrl)try{let u=new URL(d.redirectUrl,window.location.href);if(u.protocol==="http:"||u.protocol==="https:"){window.location.href=u.href;return}}catch{}i(!1)}return c("div",{class:`pe-today-wrap ${o}`,style:{"--pe-primary":e.primaryColor},children:[r&&c("div",{class:"pe-today-panel",role:"dialog","aria-label":"Today's offers",children:[c("div",{class:"pe-today-panel-header",children:[c("h3",{class:"pe-today-panel-title",children:"Today's Offers"}),c("button",{class:"pe-today-close",onClick:()=>i(!1),"aria-label":"Close",children:"\u2715"})]}),c("div",{class:"pe-today-offers",children:t.map(d=>c("div",{class:"pe-today-offer-item",onClick:()=>a(d),role:"button",tabIndex:0,onKeyDown:u=>{u.key==="Enter"&&a(d)},children:[d.imageUrl?c("img",{class:"pe-today-offer-img",src:d.imageUrl,alt:d.title,loading:"lazy"}):c("div",{class:"pe-today-offer-img","aria-hidden":"true",children:"\u{1F381}"}),c("div",{class:"pe-today-offer-info",children:[c("p",{class:"pe-today-offer-title",children:d.title}),d.description&&c("p",{class:"pe-today-offer-desc",children:d.description})]}),c("span",{class:"pe-today-offer-btn",children:d.buttonText||"View \u2192"})]},d.offerId))})]}),c("button",{class:"pe-today-trigger",onClick:()=>{i(d=>!d),r||k("promo_engine:widget_viewed",{widget_type:"today_offer",offer_count:t.length,session_id:n})},"aria-expanded":r,"aria-haspopup":"dialog","aria-label":`${t.length} offer${t.length!==1?"s":""} available`,children:[c("span",{class:"pe-today-icon","aria-hidden":"true",children:"\u{1F381}"}),e.style==="icon_title"&&c("span",{children:"Today's Deals"}),c("span",{class:"pe-today-dot","aria-hidden":"true"})]})]})}var Y=null;function _t(t,e){let n={...Wt,...t};if(!document.getElementById("pe-today-styles")){let r=document.createElement("style");r.id="pe-today-styles",r.textContent=Vt,document.head.appendChild(r)}Y||(Y=document.createElement("div"),Y.id="pe-today-offer-root",document.body.appendChild(Y)),I(g.EvaluationCompleted,r=>{let i=(Array.isArray(r.qualifiedOffers)?r.qualifiedOffers:[]).map(o=>({offerId:o.offerId,title:o.type+" offer",description:"",imageUrl:null,buttonText:"View",redirectUrl:null,badgeText:null}));H(M(Kt,{items:i,config:n,sessionId:e}),Y)})}function ht(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Yt(t,e){return[...e].sort((n,r)=>r.minQuantity-n.minQuantity).find(n=>t>=n.minQuantity)??null}function Jt({config:t,sessionId:e}){let[n,r]=q(0),[i,o]=q(new Map),[a,d]=q(""),u="name_asc",[l,f]=q(!1),[s,h]=q(!1),p=t.layoutMode==="one_step_per_page",x=p?[t.steps[n]].filter(Boolean):t.steps,E=lt(()=>{let _=0;for(let P of i.values())for(let L of P.values())_+=L;return _},[i]),m=Yt(E,t.tiers);function b(_,P,L){o(O=>{let y=new Map(O),S=new Map(y.get(_)??[]);return L===0?S.delete(P):S.set(P,L),y.set(_,S),y})}function v(_){return[...i.get(_)?.values()??[]].reduce((P,L)=>P+L,0)}function R(_){let P=v(_.id);return P>=_.minQuantity&&(_.maxQuantity===null||P<=_.maxQuantity)}async function D(){if(!l){f(!0);try{let _=[];for(let[P,L]of i.entries())for(let[O,y]of L.entries())_.push({variantId:O,quantity:y,properties:{_promo_engine_line_type:"bundle_component",_promo_engine_offer_id:t.offerId,_promo_engine_bundle_id:t.bundleId,_promo_engine_bundle_step_id:P,_promo_engine_bundle_title:t.title,_promo_engine_hash:""}});await $.addLines(_),h(!0),w(g.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,bundle_id:t.bundleId,total_qty:E,session_id:e})}finally{f(!1)}}}return s?c("div",{class:"pe-bb-success",children:[c("p",{children:"\u2713 Bundle added to cart!"}),c("button",{onClick:()=>h(!1),children:"Build Another"})]}):c("div",{class:"pe-bb",children:[c("h1",{class:"pe-bb-title",children:t.title}),t.description&&c("p",{class:"pe-bb-desc",children:t.description}),t.tiers.length>0&&c("div",{class:"pe-bb-tiers",children:t.tiers.map(_=>c("div",{class:`pe-bb-tier${m?.minQuantity===_.minQuantity?" pe-active":""}`,children:[c("span",{class:"pe-bb-tier-label",children:_.label}),c("span",{class:"pe-bb-tier-qty",children:["Buy ",_.minQuantity,"+"]}),c("span",{class:"pe-bb-tier-discount",children:_.discountType==="percentage"?`-${Math.round(_.discountValue)}%`:ht(_.discountValue,t.currency)})]},_.minQuantity))}),x.map(_=>{let P=v(_.id),L=R(_),O=_.products.filter(y=>!a||y.title.toLowerCase().includes(a.toLowerCase())).sort((y,S)=>u==="price_asc"?y.priceCents-S.priceCents:u==="price_desc"?S.priceCents-y.priceCents:y.title.localeCompare(S.title));return c("div",{class:"pe-bb-step",children:[c("div",{class:"pe-bb-step-header",children:[c("h2",{class:"pe-bb-step-title",children:[p&&`Step ${n+1} of ${t.steps.length}: `,_.title]}),_.subtitle&&c("p",{class:"pe-bb-step-subtitle",children:_.subtitle}),c("p",{class:"pe-bb-step-count",children:[P," selected",_.minQuantity>0&&` (min ${_.minQuantity})`,_.maxQuantity&&` (max ${_.maxQuantity})`,L&&" \u2713"]})]}),_.searchEnabled&&c("input",{class:"pe-bb-search",type:"text",placeholder:"Search products...",value:a,onInput:y=>d(y.target.value),"aria-label":"Search products in this step"}),c("div",{class:"pe-bb-products",children:O.map(y=>{let S=i.get(_.id)?.get(y.variantId)??0,De=_.maxQuantity!==null&&P>=_.maxQuantity&&S===0;return c("div",{class:`pe-bb-product${S>0?" pe-selected":""}${y.isAvailable?"":" pe-unavailable"}${De?" pe-at-max":""}`,children:[y.imageUrl&&c("img",{class:"pe-bb-img",src:y.imageUrl,alt:y.title,loading:"lazy"}),c("p",{class:"pe-bb-product-name",children:y.title}),y.variantTitle&&c("p",{class:"pe-bb-variant",children:y.variantTitle}),c("p",{class:"pe-bb-price",children:ht(y.priceCents,t.currency)}),y.isAvailable?c("div",{class:"pe-bb-qty-ctrl",children:[c("button",{onClick:()=>b(_.id,y.variantId,Math.max(0,S-1)),disabled:S===0,"aria-label":`Remove ${y.title}`,children:"\u2212"}),c("span",{class:"pe-bb-qty",children:S}),c("button",{onClick:()=>b(_.id,y.variantId,S+1),disabled:De,"aria-label":`Add ${y.title}`,children:"+"})]}):c("span",{class:"pe-bb-oos",children:"Out of stock"})]},y.variantId)})})]},_.id)}),c("div",{class:"pe-bb-footer",children:p?c("div",{class:"pe-bb-nav",children:[n>0&&c("button",{class:"pe-bb-btn-prev",onClick:()=>r(_=>_-1),children:"\u2190 Previous"}),n<t.steps.length-1?c("button",{class:"pe-bb-btn-next",onClick:()=>{k("promo_engine:bundle_step_completed",{offer_id:t.offerId,step_index:n,session_id:e}),r(_=>_+1)},disabled:!t.steps[n]||!R(t.steps[n]),children:"Next \u2192"}):c("button",{class:"pe-bb-btn-add",onClick:D,disabled:l||!t.steps.every(_=>R(_)),children:l?"Adding\u2026":`Add Bundle to Cart${m?` (${m.label})`:""}`})]}):c("div",{class:"pe-bb-summary",children:[c("p",{class:"pe-bb-total",children:[E," items selected"]}),m&&c("p",{class:"pe-bb-saving",children:["\u{1F4B0} ",m.label," applied!"]}),c("button",{class:"pe-bb-btn-add",onClick:D,disabled:l||!t.steps.every(_=>R(_)),children:l?"Adding\u2026":"Add Bundle to Cart"})]})})]})}function gt(t,e,n){H(M(Jt,{config:e,sessionId:n}),t)}var Ae=class extends HTMLElement{offerId="";widgetId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.widgetId=this.getAttribute("widget-id")??"",this.attachShadow({mode:"open"}),this.renderSkeleton(),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=(Array.isArray(e.progressBars)?e.progressBars:[]).find(r=>r.offerId===this.offerId||r.widgetId===this.widgetId);n&&this.renderPayload(n)})}disconnectedCallback(){this.unsubscribe?.()}renderSkeleton(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
...
`,Re=class extends HTMLElement{offerId="";variantId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.variantId=this.getAttribute("variant-id")??"",this.attachShadow({mode:"open"}),this.render(null),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=Array.isArray(e.qualifiedOffers)?e.qualifiedOffers.find(r=>r.offerId===this.offerId):null;this.render(n?{offerName:"Free Gift Available"}:null)}),I(g.ProductChanged,e=>{this.variantId=e.variantId})}disconnectedCallback(){this.unsubscribe?.()}render(e){if(!this.shadowRoot)return;let n=pe(this.getAttribute("label")??"Free Gift"),r=parseInt(this.getAttribute("countdown-seconds")??"0",10),i=pe(e?.offerName??""),o=pe(this.offerId);this.shadowRoot.innerHTML=`
      <style>${Zt}</style>
...
`,$e=class extends HTMLElement{offerId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.attachShadow({mode:"open"}),this.render(null),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=Array.isArray(e.qualifiedOffers)?e.qualifiedOffers.find(i=>i.offerId===this.offerId):null,r=e.giftSlider;this.render(n&&r?r.selectableGifts:null)})}disconnectedCallback(){this.unsubscribe?.()}render(e){if(!this.shadowRoot)return;if(!e||e.length===0){this.shadowRoot.innerHTML=`<style>${bt}</style><div class="pe-thumb-wrap pe-hidden"></div>`;return}let r=e.slice(0,4).map(i=>{let o=Xt(i.imageUrl),a=pe(i.title);return o?`<div class="pe-thumb-product">
    ...
    `,this.shadowRoot.querySelector(".pe-thumb-cta")?.addEventListener("click",()=>{w(g.GiftSliderRequested,{offerId:this.offerId})})}};customElements.define("promo-gift-thumbnail",$e);var en=`
:host { display: block; }
