...
type Module = typeof import("../app.offers.new.subscription.$template.js")

type Info = GetInfo<{
  file: "routes/app.offers.new.subscription.$template.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.new.subscription.$template.js");
}];
