...
type Module = typeof import("../apps.promo-engine.product-customizations.js")

type Info = GetInfo<{
  file: "routes/apps.promo-engine.product-customizations.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../apps.promo-engine.product-customizations.js");
}];
