...
type Module = typeof import("../apps.promo-engine.customer.order-attribution.js")

type Info = GetInfo<{
  file: "routes/apps.promo-engine.customer.order-attribution.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../apps.promo-engine.customer.order-attribution.js");
}];
