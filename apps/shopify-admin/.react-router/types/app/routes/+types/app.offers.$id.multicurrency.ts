...
type Module = typeof import("../app.offers.$id.multicurrency.js")

type Info = GetInfo<{
  file: "routes/app.offers.$id.multicurrency.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.$id.multicurrency.js");
}];
