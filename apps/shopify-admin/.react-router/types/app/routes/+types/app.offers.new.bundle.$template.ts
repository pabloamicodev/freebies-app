...
type Module = typeof import("../app.offers.new.bundle.$template.js")

type Info = GetInfo<{
  file: "routes/app.offers.new.bundle.$template.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.new.bundle.$template.js");
}];
