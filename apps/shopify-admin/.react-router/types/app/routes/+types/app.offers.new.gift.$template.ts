...
type Module = typeof import("../app.offers.new.gift.$template.js")

type Info = GetInfo<{
  file: "routes/app.offers.new.gift.$template.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.new.gift.$template.js");
}];
