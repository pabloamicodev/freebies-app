...
type Module = typeof import("../app.offers.new.discount.$template.js")

type Info = GetInfo<{
  file: "routes/app.offers.new.discount.$template.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.new.discount.$template.js");
}];
