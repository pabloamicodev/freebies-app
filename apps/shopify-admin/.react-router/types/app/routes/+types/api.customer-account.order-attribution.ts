...
type Module = typeof import("../api.customer-account.order-attribution.js")

type Info = GetInfo<{
  file: "routes/api.customer-account.order-attribution.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.customer-account.order-attribution.js");
}];
