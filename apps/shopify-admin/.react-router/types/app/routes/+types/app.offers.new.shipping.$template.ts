...
type Module = typeof import("../app.offers.new.shipping.$template.js")

type Info = GetInfo<{
  file: "routes/app.offers.new.shipping.$template.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.offers.new.shipping.$template.js");
}];
