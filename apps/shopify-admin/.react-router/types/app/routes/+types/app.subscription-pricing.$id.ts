...
type Module = typeof import("../app.subscription-pricing.$id.js")

type Info = GetInfo<{
  file: "routes/app.subscription-pricing.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.subscription-pricing.$id.js");
}];
