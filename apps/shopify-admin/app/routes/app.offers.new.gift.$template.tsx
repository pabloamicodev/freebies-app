...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const minAmountResult = parseMoneyAmount(formData, "minAmount", 500, {
    min: 0,
    label: "Minimum amount",
  });
  if (minAmountResult.error) return { error: minAmountResult.error };
  const maxAmountResult = parseMoneyAmount(formData, "maxAmount", 0, {
    min: 0,
  ...
  if (conditionType === "specific_product") {
    conditionValue = {
      ...
      multiplyGifts,
      giftsMatchProducts: giftsMatchProd,
      trackMode,
    ...
    conditionValue = {
      thresholdCents: Math.round(minAmount * 100),
      maxAmountCents: Math.round(maxAmount * 100),
      appliesTo,
  ...
  const discountValueResult = parseMoneyAmount(formData, "discountValue", 100, {
    min: 0,
    ...
    return db.transaction(async (tx) => {
      ...
      await Promise.all([
        ...
        tx.insert(offerCombinationPolicies).values({
          ...
          stopLowerPriority,
          giftValueCountsForOtherOffers: giftValueCountsForOther,
        }),
      ]);
    ...
    <div className="b-page">
      ...
      >
        <input
          type="hidden"
          name="conditionType"
          value={isScratch ? selectedMainCond : conditionType}
        />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                <div>
                  <label className="b-label" htmlFor="internalName">
                    Offer name <span style={{ color: "var(--red, #e53e3e)" }}>*</span>
                  </label>
                  <input
                    id="internalName"
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((p) => ({ ...p, internalName: undefined }));
                    }}
                    autoComplete="off"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFieldErrors((p) => ({ ...p, publicTitle: undefined }));
                    }}
                    autoComplete="off"
                  />
                ...
                <div className="b-grid-2">
                  ...
                  <div>
                    <label className="b-label" htmlFor="endsAt">
                      End time{" "}
                      <span style={{ fontWeight: 400, color: "var(--text-sub)" }}>(optional)</span>
                    </label>
                    <input
                      id="endsAt"
                      className="b-input"
            ...
            {!isScratch && (
              <div>
                ...
                <div className="b-card">
                  ...
                  >
                    <span style={{ fontFamily: "var(--font-display)", fontWeight: 600 }}>
                      {CONDITION_TYPE_LABEL[conditionType]}
                    </span>
                    <button
                      type="button"
                      className="b-modal-close"
                      aria-label="Change main condition"
                  ...
                  >
                    ...
                    {conditionType === "cart_value" && (
                      <>
                        <div className="b-grid-2">
                          ...
                          <div>
                            <label className="b-label" htmlFor="gift-max-amount">
                              Max.
                            </label>
                            <div style={{ position: "relative" }}>
                              <span
                        ...
                        <div>
                          <label className="b-label" htmlFor="gift-cart-value-applies-to">
                            Condition applies to:
                          </label>
                          <select
                            id="gift-cart-value-applies-to"
                    ...
                    {conditionType === "cart_value_multiplier" && (
                      <>
                        <div>
                          <label className="b-label" htmlFor="gift-base-multiplier-value">
                          ...
                          <div style={{ position: "relative", maxWidth: 280 }}>
                            ...
                            <input
                              id="gift-base-multiplier-value"
                              aria-label="Base multiplier value"
                              className="b-input"
                              type="number"
                              name="minAmount"
                              value={minAmount}
                          ...
                          <div className="b-help">
                            Example: with base value $100, customers get 1 gift when cart exceeds
                            $100, 2 gifts over $200, and so on.
                          </div>
                        </div>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                          <span style={{ color: "var(--text-sub)", display: "flex" }}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                              <path d="M6.5 5.275v-1.025c0-.69.56-1.25 1.25-1.25h4.5c.69 0 1.25.56 1.25 1.25v1.025c0 .448-.24.862-.63 1.085l-.43.246.866 3.894h.694c.69 0 1.25.56 1.25 1.25v1c0 .69-.56 1.25-1.25 1.25h-2.781l-.48 2.873a.75.75 0 0 1-1.479 0l-.479-2.873h-2.781c-.69 0-1.25-.56-1.25-1.25v-1c0-.69.56-1.25 1.25-1.25h.694l.866-3.894-.43-.246a1.25 1.25 0 0 1-.63-1.085Z" />
                            </svg>
                          </span>
                        </div>

                        <div>
                          <label className="b-label" htmlFor="gift-multiplier-applies-to">
                            Condition applies to:
                          </label>
                          <select
                            id="gift-multiplier-applies-to"
                            aria-label="Condition applies to"
                            className="b-select"
                            value={appliesTo}
                            onChange={(e) => setAppliesTo(e.target.value)}
                    ...
                    {conditionType === "cart_quantity" && (
                      <>
                        <div className="b-grid-2">
                          ...
                          <div>
                            <label className="b-label" htmlFor="gift-max-qty">
                              Max.
                            </label>
                            <input
                              id="gift-max-qty"
                        ...
                        <div>
                          <label className="b-label" htmlFor="gift-quantity-applies-to">
                            Condition applies to:
                          </label>
                          <select
                            id="gift-quantity-applies-to"
                            aria-label="Condition applies to"
                            className="b-select"
                            value={appliesTo}
                            onChange={(e) => setAppliesTo(e.target.value)}
                    ...
                    {conditionType === "specific_product" && (
                      <>
                        <div>
                          <label className="b-label" htmlFor="gift-required-product-quantity">
                            Required product quantity
                          </label>
                          <input
                            id="gift-required-product-quantity"
                        ...
                        <label
                          ...
                          htmlFor="gift-multiply-gifts"
                          style={{ cursor: "pointer", gap: 10 }}
                        >
                          <input
                            id="gift-multiply-gifts"
                            aria-label="Multiply gifts by product quantity"
                            type="checkbox"
                            name="multiplyGifts"
                          ...
                          <div>
                            <div className="b-checkbox-label">
                              Multiply gifts by product quantity
                            </div>
                            <div className="b-checkbox-help">
                              Customers get more gifts the more qualifying products they buy.
                            </div>
                          </div>
                        </label>
                        <label
                          className="b-checkbox-row"
                          htmlFor="gift-match-products"
                          style={{ cursor: "pointer", gap: 10 }}
                        >
                          <input
                            id="gift-match-products"
                            aria-label="Gifts match the selected products"
                            type="checkbox"
                            name="giftsMatchProducts"
                            checked={giftsMatchProducts}
                            onChange={(e) => setGiftsMatchProducts(e.target.checked)}
                          />
                          <div className="b-checkbox-label">
                            Gifts match the selected products (BOGO).
                          </div>
                        </label>
                        <div
                          style={{
                        ...
                        >
                          {[
                            { v: "variant", l: "Track by variant" },
                            { v: "product", l: "Track by product" },
                          ].map((opt) => (
                            <label
                              key={opt.v}
                              className="b-checkbox-row"
                              htmlFor={`gift-track-${opt.v}`}
                              style={{
                                cursor: giftsMatchProducts ? "pointer" : "not-allowed",
                                gap: 8,
                                opacity: giftsMatchProducts ? 1 : 0.5,
                              }}
                            >
                              <input
                                id={`gift-track-${opt.v}`}
                                ...
                                name="trackMode"
                                value={opt.v}
                                checked={trackMode === opt.v}
                                disabled={!giftsMatchProducts}
                                onChange={() => setTrackMode(opt.v)}
                                style={{ accentColor: "var(--gift-color)", width: 14, height: 14 }}
                              />
                              <span
                                style={{
                                  fontSize: 13,
                                  color: giftsMatchProducts ? "var(--text)" : "var(--text-sub)",
                                }}
                              >
                                {opt.l}
                              </span>
                        ...
                        <div>
                          <label className="b-label" htmlFor="gift-specific-applies-to">
                            Condition applies to:
                          </label>
                          <select
                            id="gift-specific-applies-to"
                            aria-label="Condition applies to"
                            className="b-select"
                            value={appliesTo}
                            onChange={(e) => setAppliesTo(e.target.value)}
                        ...
                        <div>
                          ...
                          <SelectedProductsList
                            gids={conditionProducts}
                            onRemove={(gid) =>
                              setConditionProducts(conditionProducts.filter((id) => id !== gid))
                            }
                          />
                        </div>
                      </>
              ...
              <div className="b-card" style={{ borderTop: "3px solid var(--gift-color)" }}>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    >
                      {selectedMainCond
                        ? `Change: ${CONDITION_TYPE_LABEL[selectedMainCond]}`
                        : "+ Add main condition"}
                    </button>
                    {!selectedMainCond && (
                  ...
                  {selectedMainCond === "cart_value" && (
                    <>
                      <div className="b-grid-2">
                        ...
                        <div>
                          <label className="b-label" htmlFor="scratch-gift-max-amount">
                            Max.
                          </label>
                          <div style={{ position: "relative" }}>
                            <span
                      ...
                      <div>
                        <label className="b-label" htmlFor="scratch-gift-applies-to-cv">
                          Condition applies to:
                        </label>
                        <select
                          id="scratch-gift-applies-to-cv"
                          aria-label="Condition applies to"
                          className="b-select"
                          value={appliesTo}
                          onChange={(e) => setAppliesTo(e.target.value)}
                  ...
                  {selectedMainCond === "cart_quantity" && (
                    <>
                      ...
                      <div>
                        <label className="b-label" htmlFor="scratch-gift-applies-to-cq">
                          Condition applies to:
                        </label>
                        <select
                          id="scratch-gift-applies-to-cq"
                          aria-label="Condition applies to"
                          className="b-select"
                          value={appliesTo}
                          onChange={(e) => setAppliesTo(e.target.value)}
                  ...
                  {selectedMainCond === "specific_product" && (
                    <>
                      <div>
                        <label className="b-label" htmlFor="scratch-gift-min-qty-sp">
                          Required product quantity
                        </label>
                        <input
                          id="scratch-gift-min-qty-sp"
                          aria-label="Required product quantity"
                          className="b-input"
                          type="number"
                          name="minQty"
            ...
            <div>
                  ...
                  {activeSubs.map((id) => {
                    ...
                    return (
                      <SubconditionCard
                        ...
                        onToggleCollapse={() =>
                          setCollapsedSubs({ ...collapsedSubs, [id]: !collapsedSubs[id] })
                        }
                        onRemove={() => {
              ...
              {activeSubs.length > 0 && (
                <div style={{ marginTop: 6, fontSize: 13, color: "var(--text-sub)" }}>
                  Sub-conditions combine additional filters like specific links, markets, customer
                  location, etc. Sub-conditions are optional.
                </div>
              )}
            </div>
                ...
                >
                  <div>
                    ...
                    <div className="b-grid-2">
                      <div>
                        ...
                        <select
                          id="gift-discount-type"
                          aria-label="Gift discount type"
                          className="b-select"
                          name="discountType"
                          value={discountType}
                      ...
                      <div>
                        <label className="b-label" htmlFor="gift-discount-value">
                          Value:
                        </label>
                        <div style={{ position: "relative" }}>
                          <span
                  ...
                  <div>
                    ...
                    <label
                      ...
                      style={{
                        cursor: isBogo ? "not-allowed" : "pointer",
                        gap: 10,
                        marginBottom: 6,
                        opacity: isBogo ? 0.5 : 1,
                      }}
                    >
                      <input
                        id="gift-auto-add-all"
                        aria-label="Automatically add all gifts"
                        type="radio"
                        name="_autoAddRadio"
                        checked={isAutoAdd}
                        disabled={isBogo}
                      ...
                      />
                      <span
                        style={{ fontSize: 13, color: isBogo ? "var(--text-sub)" : "var(--text)" }}
                      >
                        Automatically add all gifts
                      </span>
                    </label>
                    <label
                      className="b-checkbox-row"
                      htmlFor="gift-customer-selects"
                      style={{ cursor: "pointer", gap: 10 }}
                    >
                      <input
                        id="gift-customer-selects"
                        aria-label="Customer selects number of gifts"
                        type="radio"
                        name="_autoAddRadio"
                        checked={!isAutoAdd}
                      ...
                      <span style={{ fontSize: 13, color: "var(--text)" }}>
                        Customer selects number of gifts
                      </span>
                    </label>
                    {!isAutoAdd && (
                      <input
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <SelectedProductsList
                      gids={rewardProducts}
                      onRemove={(gid) =>
                        setRewardProducts(rewardProducts.filter((id) => id !== gid))
                      }
                    />
                  </div>
            ...
            <div className="b-card">
              <button
                type="button"
                className="b-card-header rd-style-029"
              ...
              >
                ...
                <span style={{ color: "var(--text-sub)", display: "flex" }}>
                  {advancedOpen ? <IChevUp /> : <IChevDown />}
                </span>
              </button>
              ...
              {advancedOpen && (
                ...
                >
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <div>
                      <label className="b-label" htmlFor="priority">
                        Priority
                      </label>
                      <input
                        id="priority"
                    ...
                    >
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={stopLower}
                          onChange={(e) => setStopLower(e.target.checked)}
                          style={{ marginTop: 2 }}
                        />
                        <div>
                          ...
                          <div style={{ fontSize: 12, color: "var(--text-sub)" }}>
                            Offers with priority 2, 3,... will stop if customers meet this offer's
                            conditions
                          </div>
                        </div>
                      </label>
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={giftAppliesOther}
                          onChange={(e) => setGiftAppliesOther(e.target.checked)}
                          style={{ marginTop: 2 }}
                        />
                        <div>
                          <div style={{ fontSize: 13, fontWeight: 500, color: "var(--text)" }}>
                            Gift applies to other rules.
                          </div>
                          <div style={{ fontSize: 12, color: "var(--text-sub)" }}>
                            The gift value will apply to other rules when the gift price is greater
                            than 0.
                          </div>
                        </div>
                      </label>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "var(--text-sub)", marginBottom: 8 }}>
                      This is applied when offer is displayed on Cart page on your Online Store.
                    </div>
                    <label className="b-checkbox-row" style={{ cursor: "pointer", gap: 10 }}>
                      <input
                        type="checkbox"
                        checked={addCartMessage}
                        onChange={(e) => setAddCartMessage(e.target.checked)}
                      />
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "var(--text-sub)", marginBottom: 10 }}>
                      ...
                      . Leave blank if using Boosters. If you&apos;re still on this version,
                      configure the display text and redirect link below.
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <div>
                        <label className="b-label" htmlFor="today-offer-title">
                          Offer title
                        </label>
                        <input
                          ...
                          className="b-input"
                          value={offerTodayTitle}
                          onChange={(e) => setOfferTodayTitle(e.target.value)}
                          placeholder="Enter offer title"
                          autoComplete="off"
                        />
                        <div className="b-help">
                          If blank, the original title will be used. Changing this won&apos;t affect
                          the original offer title.
                        </div>
                      </div>
                      <label
                        className="b-checkbox-row"
                        htmlFor="today-offer-add-redirect"
                        style={{ cursor: "pointer", gap: 10 }}
                      >
                        <input
                          id="today-offer-add-redirect"
                          aria-label="Add a redirect button"
                          type="checkbox"
                          checked={addRedirectBtn}
                          onChange={(e) => setAddRedirectBtn(e.target.checked)}
                        />
                        <span style={{ fontSize: 13, color: "var(--text)" }}>
        ...
        <div className="rd-style-031">
          ...
          <button
            ...
            style={{ background: "var(--gift-grad)", boxShadow: "0 4px 12px rgba(217,119,6,0.3)" }}
            disabled={isSubmitting}
          >
