    ...
    IllusComponent: () => (
      ...
      >
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#6d7175", marginBottom: 4 }}>
            Buy X
          </div>
          <div className="rd-style-037">👕</div>
        </div>
...
const OFFER_CATALOG = [
  ...
  },
  {
    value: "shipping",
    name: "Shipping offer",
    tagline: "Global, landing, and subscription shipping rules",
    examples: ["Free shipping above a tier", "Landing-only shipping discount"],
    accent: "#38bdf8",
...
/* ══════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════ */
function Modal2GiftWizard({ onClose, onBack }: { onClose: () => void; onBack: () => void }) {
    ...
    <AccessibleModal ariaLabel="Create gift offer" onClose={onClose}>
      ...
      <div className="b-modal-body">
        ...
        >
          ...
          <div className="b-template-scratch-desc">
            Create offers manually, from conditions to gifts.
          </div>
        </button>
...
const BUNDLE_TEMPLATES = [
  {
    ...
    IllusComponent: () => (
      ...
      >
        <div style={{ fontWeight: 700, fontSize: 12, marginBottom: 8, color: "#202223" }}>
        ...
        {[
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: 12, color: "#babec3", textDecoration: "line-through" }}>
                {item.orig}
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div>
            ...
            <span style={{ fontSize: 12, color: "#babec3", textDecoration: "line-through" }}>
              $170.00
            </span>
          </div>
        </div>
  ...
  },
  {
    ...
    IllusComponent: () => (
      ...
      >
        ...
        <div style={{ fontWeight: 600, fontSize: 12, marginBottom: 8, color: "#202223" }}>
          Select items for your own bundle
        </div>
              ...
              <div className="b-template-info">
                <div className="b-template-radio-row" aria-hidden="true">
                  ...
                  <p className="b-template-name">
                    {tmpl.name}
                    {tmpl.shopifyPlus && (
                      <span className="b-shopify-plus-badge">Shopify Plus only</span>
                    )}
                  </p>
                </div>
                <p className="b-template-desc">{tmpl.desc}</p>
...
const UPSELL_TEMPLATES = [
    ...
    IllusComponent: () => (
      ...
      >
        ...
        <div style={{ padding: "8px 10px", display: "flex", gap: 8, alignItems: "center" }}>
          <div
            style={{ width: 32, height: 32, background: "#f3f4f6", borderRadius: 4, flexShrink: 0 }}
          />
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: "#202223", marginBottom: 2 }}>
              Radiant Glow Serum
            </div>
            <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
              <span style={{ fontSize: 12, color: "#2c6ecb", fontWeight: 700 }}>$5.99</span>
              <span style={{ fontSize: 12, textDecoration: "line-through", color: "#babec3" }}>
                $9.99
              </span>
            </div>
          </div>
        ...
        <div style={{ padding: "4px 10px 8px" }}>
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              style={{ height: 4, background: "#f3f4f6", borderRadius: 2, marginBottom: 4 }}
            />
          ))}
        </div>
      </div>
  ...
  },
  {
    ...
    IllusComponent: () => (
      ...
      >
        <div style={{ fontSize: 12, fontWeight: 700, color: "#202223", marginBottom: 8 }}>
  ...
  },
  {
    ...
    IllusComponent: () => (
      ...
      >
        ...
        <div
          style={{ padding: "8px 10px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}
        >
          <div>
            {[1, 2, 3].map((i) => (
              <div
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#2c6ecb", fontWeight: 600, marginBottom: 4 }}>
              $5.99 <span style={{ color: "#babec3", textDecoration: "line-through" }}>$9.99</span>
            </div>
            <div
              style={{
                background: "#2c6ecb",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                border: "1.5px solid #babec3",
                background: row.selected ? "#2c6ecb" : "white",
                flexShrink: 0,
              }}
            />
            ...
            <div style={{ textAlign: "right" }}>
              <div
                style={{
                  fontSize: 12,
                  fontWeight: 600,
                  color: row.selected ? "#2c6ecb" : "#202223",
                }}
              >
                {row.price}
              </div>
              {row.orig && (
                <div style={{ fontSize: 12, textDecoration: "line-through", color: "#babec3" }}>
                  {row.orig}
                </div>
              )}
            </div>
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                border: "1.5px solid #babec3",
                background: checked ? "#2c6ecb" : "white",
                flexShrink: 0,
              }}
            />
            <div style={{ flex: 1, height: 4, background: "#f3f4f6", borderRadius: 2 }} />
    ...
    IllusComponent: () => (
      <div style={{ width: "90%", display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          >
            ...
            <span
              style={{
                ...
                color: tier.active ? "#2c6ecb" : tier.loading ? "#babec3" : "#6d7175",
              }}
            >
              {tier.label}
            </span>
        ...
        >
          ...
          <div>
            <div
              style={{ fontSize: 12, fontWeight: 600, color: "#6d7175", letterSpacing: "0.5px" }}
            >
              CART VALUE
            </div>
...
const SHIPPING_TEMPLATES = [
  {
    ...
    desc: "Apply subtotal tiers across the storefront.",
    badge: "Storewide",
  },
  {
    id: "landing",
    name: "Landing-page shipping",
    desc: "Require a trusted landing source and optional anchor products.",
    badge: "URL scoped",
  },
  {
    id: "quiz",
    name: "Quiz bundle shipping",
    desc: "Apply shipping to qualifying quiz or subscription bundles.",
    badge: "Bundle scoped",
  },
];

function Modal2ShippingWizard({ onClose, onBack }: { onClose: () => void; onBack: () => void }) {
  const [selected, setSelected] = useState("global");
  const navigate = useNavigate();
  return (
    <AccessibleModal ariaLabel="Create shipping offer" onClose={onClose}>
      <div className="b-modal-header">
        <div>
          <h2 className="b-modal-title">Create shipping offer</h2>
          <p className="b-modal-subtitle">Choose how this shipping rule is scoped</p>
        </div>
        <button type="button" className="b-modal-close" onClick={onClose} aria-label="Close">
          <svg
            width="14"
        ...
        <div className="b-template-grid">
          {SHIPPING_TEMPLATES.map((template) => (
            <button
              key={template.id}
              type="button"
              className={`b-template-card${selected === template.id ? " selected" : ""}`}
...
export default function OfferCreateModalFlow({
  modal,
  onClose,
  onChange,
