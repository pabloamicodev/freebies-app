"use strict";var PromoEngine=(()=>{var ue=Object.defineProperty;var vt=Object.getOwnPropertyDescriptor;var xt=Object.getOwnPropertyNames;var Ct=Object.prototype.hasOwnProperty;var wt=(t,e)=>{for(var n in e)ue(t,n,{get:e[n],enumerable:!0})},It=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of xt(e))!Ct.call(t,i)&&i!==n&&ue(t,i,{get:()=>e[i],enumerable:!(r=vt(e,i))||r.enumerable});return t};var kt=t=>It(ue({},"__esModule",{value:!0}),t);var nn={};wt(nn,{AbortableRequest:()=>F,AjaxCartAdapter:()=>R,PromoEvents:()=>g,StorefrontApiAdapter:()=>Z,debounce:()=>X,emit:()=>w,initBundleBuilder:()=>ht,initCartDrawerIntegration:()=>He,initFbtWidget:()=>_t,initGiftSlider:()=>ft,initTodayOfferWidget:()=>mt,on:()=>I,publishAnalytics:()=>k});var Me=Promise.resolve();function Q(t){return new Promise((e,n)=>{Me=Me.then(t).then(e,n)})}async function B(t,e){let n=await fetch(t,{...e,headers:{"Content-Type":"application/json",Accept:"application/json",...e?.headers}});if(!n.ok){let r=await n.text();throw new Error(`Cart API error ${n.status}: ${r}`)}return n.json()}var R={async getCart(){return B(`${window.Shopify?.routes?.root??"/"}cart.js`)},async addLines(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/add.js`,{method:"POST",body:JSON.stringify({items:t.map(e=>({id:parseInt(e.variantId.split("/").pop()??e.variantId,10),quantity:e.quantity,properties:e.properties}))})}))},async updateLine(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/change.js`,{method:"POST",body:JSON.stringify({id:t.key,quantity:t.quantity,...t.properties?{properties:t.properties}:{}})}))},async removeLine(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/change.js`,{method:"POST",body:JSON.stringify({id:t.key,quantity:0})}))},async applyDiscountCode(t){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/update.js`,{method:"POST",body:JSON.stringify({discount:t})}))},async removeDiscountCode(){return Q(()=>B(`${window.Shopify?.routes?.root??"/"}cart/update.js`,{method:"POST",body:JSON.stringify({discount:""})}))}};function X(t,e){let n=null,r=null;function i(...d){r=d,n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,r&&t(...r)},e)}function o(){n!==null&&(clearTimeout(n),n=null)}function a(){o(),r&&t(...r)}return{call:i,cancel:o,flush:a}}var F=class{controller=null;start(){return this.controller&&this.controller.abort("superseded"),this.controller=new AbortController,this.controller.signal}cancel(){this.controller&&(this.controller.abort("cancelled"),this.controller=null)}};var g={CartChanged:"promo-engine:cart-changed",EvaluationRequested:"promo-engine:evaluation-requested",EvaluationCompleted:"promo-engine:evaluation-completed",GiftAutoAdded:"promo-engine:gift-auto-added",GiftAdded:"promo-engine:gift-added",GiftUpdated:"promo-engine:gift-updated",GiftRemoved:"promo-engine:gift-removed",GiftSliderRequested:"promo-engine:gift-slider-requested",GiftSliderClosed:"promo-engine:gift-slider-closed",ProductChanged:"promo-engine:product-changed",CartMessageRender:"promo-engine:cart-message-render",ProgressRerender:"promo-engine:progress-rerender",TodayOfferRender:"promo-engine:today-offer-render",BundleInit:"promo-engine:bundle-init",UpsellInit:"promo-engine:upsell-init",CheckoutPrepare:"promo-engine:checkout-prepare",CartMutationError:"promo-engine:cart-mutation-error",InventoryFailure:"promo-engine:inventory-failure"};function w(t,e){window.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0}))}function I(t,e,n){let r=i=>e(i.detail);return window.addEventListener(t,r,n),()=>window.removeEventListener(t,r)}function k(t,e){typeof window.analytics?.publish=="function"&&window.analytics.publish(t,e)}function fe(t,e,n){for(let r of t.items){if(r.variant_id!==e)continue;if(Object.entries(n).every(([o,a])=>r.properties[o]===a))return r.key}return null}function _e(t,e){return t.items.find(n=>n.properties._promo_engine_line_type==="gift"&&n.properties._promo_engine_offer_id===e)??null}async function me(){let t=await fetch(`${window.Shopify?.routes?.root??"/"}cart.js`,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error(`Cart fetch failed: ${t.status}`);return t.json()}var St=300,Et="/apps/promo-engine/evaluate",Ue="promo_engine_session_id",ge=class{config;sessionId;evaluationAbort=new F;debouncedEvaluate;lastCartHash=null;constructor(e){this.config=e,this.sessionId=this.getOrCreateSessionId(),this.debouncedEvaluate=X(this.triggerEvaluation.bind(this),St)}init(){this.log("Promo Engine initialized",this.config),this.listenForCartChanges(),this.triggerEvaluation()}getOrCreateSessionId(){try{let e=sessionStorage.getItem(Ue);return e||(e=crypto.randomUUID(),sessionStorage.setItem(Ue,e)),e}catch{return crypto.randomUUID()}}listenForCartChanges(){document.addEventListener("cart:updated",()=>this.debouncedEvaluate.call()),document.addEventListener("cart:refresh",()=>this.debouncedEvaluate.call()),document.addEventListener("theme:cart:open",()=>this.debouncedEvaluate.call()),I(g.CartChanged,()=>this.debouncedEvaluate.call());let e=new MutationObserver(()=>{this.debouncedEvaluate.call()});document.querySelectorAll('[action*="/cart"]').forEach(n=>{e.observe(n,{childList:!0,subtree:!1})}),document.querySelectorAll('input[name="quantity"], input[name*="qty"], input[type="number"][data-quantity-input]').forEach(n=>{e.observe(n,{attributes:!0,attributeFilter:["value"]})})}async triggerEvaluation(){w(g.EvaluationRequested);let e;try{e=await R.getCart()}catch(l){this.log("Failed to fetch cart",l);return}let n=this.buildCartHash(e);if(n===this.lastCartHash){this.log("Cart unchanged, skipping evaluation");return}let r=this.evaluationAbort.start(),i=window.Shopify,o=i?.currency?.active??this.config.currency,a=i?.currency?.rate,d=a?parseFloat(a):null,u=o&&o!==this.config.currency?{id:o,handle:o.toLowerCase(),currencyCode:o,countryCode:i?.country??null,primaryLocale:i?.locale??this.config.locale,exchangeRate:d&&!isNaN(d)?d:null}:null;try{let l=await fetch(Et,{method:"POST",headers:{"Content-Type":"application/json","X-Promo-Shop":this.config.shopDomain,"X-Promo-Key":this.config.publicKey,"X-Promo-Session":this.sessionId},body:JSON.stringify({cart:this.normalizeCart(e),customer:null,market:u,locale:this.config.locale,salesChannel:"online_store",requestedUrl:window.location.href,sessionId:this.sessionId}),signal:r});if(!l.ok)throw new Error(`Evaluation failed: ${l.status}`);let f=await l.json();this.lastCartHash=n,await this.applyCartActions(Array.isArray(f.cartActions)?f.cartActions:[]),w(g.EvaluationCompleted,f)}catch(l){if(l.name==="AbortError"){this.log("Evaluation aborted (superseded by newer request)");return}this.log("Evaluation error",l),w(g.CartMutationError,{error:l.message})}}async applyCartActions(e){for(let n of e)try{switch(n.action){case"add_line":{if(!n.variantId)break;let r=parseInt(n.variantId.split("/").pop()??n.variantId,10);await R.addLines([{variantId:String(r),quantity:n.quantity??1,properties:n.properties??{}}]),w(g.GiftAutoAdded,{variantId:n.variantId,quantity:n.quantity}),k("promo_engine:gift_auto_added",{variant_id:n.variantId,quantity:n.quantity,session_id:this.sessionId});break}case"update_line":{let r=await me(),o=(r.items.find(a=>a.key===n.lineKey)??(n.offerId?_e(r,n.offerId):null))?.key??(n.variantId?fe(r,parseInt(n.variantId.split("/").pop()??n.variantId,10),n.properties??{}):null);if(!o)break;n.quantity===0?(await R.removeLine({key:o}),w(g.GiftRemoved,{lineKey:o}),k("promo_engine:gift_removed",{line_key:o,reason:"quantity_correction",session_id:this.sessionId})):(await R.updateLine({key:o,quantity:n.quantity??1,properties:n.properties}),w(g.GiftUpdated,{lineKey:o,quantity:n.quantity}));break}case"remove_line":{let r=await me(),o=(r.items.find(a=>a.key===n.lineKey)??(n.offerId?_e(r,n.offerId):null))?.key??(n.variantId?fe(r,parseInt(n.variantId.split("/").pop()??n.variantId,10),n.properties??{}):null);if(!o)break;await R.removeLine({key:o}),w(g.GiftRemoved,{lineKey:o}),k("promo_engine:gift_removed",{line_key:o,reason:n.reason??"offer_disqualified",session_id:this.sessionId});break}}}catch(r){this.log("Cart action failed",{action:n,error:r}),w(g.CartMutationError,{action:n,error:r.message}),k("promo_engine:cart_mutation_error",{action_type:n.action,error:r.message,session_id:this.sessionId})}}buildCartHash(e){return[...e.items.map(r=>`${r.variant_id}:${r.quantity}`).sort(),e.currency].join("|")}normalizeCart(e){return{token:e.token,id:null,lines:e.items.map(n=>({key:n.key,variantId:`gid://shopify/ProductVariant/${n.variant_id}`,productId:`gid://shopify/Product/${n.product_id}`,quantity:n.quantity,priceCents:n.price,compareAtPriceCents:null,properties:n.properties,requiresSellingPlan:n.requires_selling_plan,sellingPlanId:n.selling_plan_allocation?"has-plan":null,productHandle:n.handle,productTitle:n.title,variantTitle:n.variant_title,vendor:n.vendor,productType:n.product_type,tags:n.tags?n.tags.split(", "):[],collections:[],availableForSale:n.available,inventoryPolicy:n.inventory_policy?.toUpperCase()==="CONTINUE"?"CONTINUE":"DENY",inventoryQuantity:n.inventory_quantity})),subtotalCents:e.total_price,discountCodes:e.discount_codes?.map(n=>n.code)??[],currencyCode:e.currency,totalQuantity:e.item_count}}log(e,...n){this.config.debug&&console.info(`[PromoEngine] ${e}`,...n)}api={refreshCart:()=>this.debouncedEvaluate.flush(),evaluate:()=>this.triggerEvaluation(),prepareCheckout:async()=>{this.debouncedEvaluate.cancel(),w(g.CheckoutPrepare),await this.triggerEvaluation()},on:(e,n)=>I(e,n)}};function Oe(){let t=window.__promoEngineConfig;if(!t){console.warn("[PromoEngine] No config found. Ensure the app embed is enabled in your theme.");return}let e=new ge(t);window.PromoEngine=e.api,e.init()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oe):Oe();function He(t={}){let{quantitySelectors:e=[".cart-count",".cart-item-count","[data-cart-count]"],customCartUpdateEvents:n=[],sectionRenderingEnabled:r=!1}=t,i=["cart:updated","cart:refresh","cart:change","cart-drawer:open","cartDrawer:open","drawer:open","theme:cart:open","turbo:cart-update","rebuy:cart-change","slide-cart:open",...n];for(let l of i)document.addEventListener(l,()=>{w(g.CartChanged)});let o=[];function a(){for(let l of e){let f=document.querySelectorAll(l);for(let s of f)o.includes(s)||(u.observe(s,{childList:!0,subtree:!0,characterData:!0}),o.push(s))}}let d=null,u=new MutationObserver(()=>{d&&clearTimeout(d),d=setTimeout(()=>w(g.CartChanged),300)});a(),new MutationObserver(()=>a()).observe(document.body,{childList:!0,subtree:!1}),r&&I(g.GiftAutoAdded,async()=>{let l=At();l.length>0&&await Tt(l)}),i.filter(l=>l.includes("open")).forEach(l=>{document.addEventListener(l,()=>{setTimeout(()=>{w(g.ProgressRerender),w(g.CartMessageRender)},100)})})}function At(){let t=document.querySelectorAll("[data-section-id]"),e=[];for(let n of t){let r=n.getAttribute("data-section-id");r&&(r.includes("cart")||r.includes("gift"))&&e.push(r)}return e}async function Tt(t){let e=t.map(n=>`sections[]=${encodeURIComponent(n)}`).join("&");try{let n=await fetch(`/cart?${e}`,{headers:{Accept:"application/json"}});if(!n.ok)return;let r=await n.json();for(let[i,o]of Object.entries(r.sections??{})){let a=document.querySelector(`[data-section-id="${i}"]`);a&&o&&(a.outerHTML=o)}}catch{}}var Z=class{endpoint;token;cartId=null;CART_ID_KEY="promo_engine_cart_id";constructor(e,n){this.endpoint=`https://${e}/api/2026-01/graphql.json`,this.token=n}async gql(e,n){let r=await fetch(this.endpoint,{method:"POST",headers:{"Content-Type":"application/json","X-Shopify-Storefront-Access-Token":this.token},body:JSON.stringify({query:e,variables:n})});if(!r.ok)throw new Error(`Storefront API error: ${r.status}`);let i=await r.json();if(i.errors?.length)throw new Error(i.errors[0].message);return i.data}getStoredCartId(){try{return localStorage.getItem(this.CART_ID_KEY)}catch{return null}}storeCartId(e){try{localStorage.setItem(this.CART_ID_KEY,e)}catch{}}async getOrCreateCart(){let e=this.getStoredCartId();if(e)try{let n=await this.fetchCart(e);if(n)return this.cartId=e,n}catch{}return this.createCart()}async fetchCart(e){return(await this.gql(`query GetCart($cartId: ID!) {
        cart(id: $cartId) {
          id checkoutUrl
      ...
      }`,{cartId:this.cartId,buyerIdentity:{countryCode:e,...n?{customerAccessToken:n}:{}}})).cartBuyerIdentityUpdate.cart}};var se,C,Fe,Pt,z,je,Ge,Qe,he,te,W,We,xe,be,ye,Lt,ie={},oe=[],Rt=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,de=Array.isArray;function H(t,e){for(var n in e)t[n]=e[n];return t}function Ce(t){t&&t.parentNode&&t.parentNode.removeChild(t)}function U(t,e,n){var r,i,o,a={};for(o in e)o=="key"?r=e[o]:o=="ref"?i=e[o]:a[o]=e[o];if(arguments.length>2&&(a.children=arguments.length>3?se.call(arguments,2):n),typeof t=="function"&&t.defaultProps!=null)for(o in t.defaultProps)a[o]===void 0&&(a[o]=t.defaultProps[o]);return ne(t,a,r,i,null)}function ne(t,e,n,r,i){var o={type:t,props:e,key:n,ref:r,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:i??++Fe,__i:-1,__u:0};return i==null&&C.vnode!=null&&C.vnode(o),o}function M(t){return t.children}function re(t,e){this.props=t,this.context=e}function G(t,e){if(e==null)return t.__?G(t.__,t.__i+1):null;for(var n;e<t.__k.length;e++)if((n=t.__k[e])!=null&&n.__e!=null)return n.__e;return typeof t.type=="function"?G(t):null}function $t(t){if(t.__P&&t.__d){var e=t.__v,n=e.__e,r=[],i=[],o=H({},e);o.__v=e.__v+1,C.vnode&&C.vnode(o),we(t.__P,o,e,t.__n,t.__P.namespaceURI,32&e.__u?[n]:null,r,n??G(e),!!(32&e.__u),i),o.__v=e.__v,o.__.__k[o.__i]=o,Je(r,o,i),e.__e=e.__=null,o.__e!=n&&Ve(o)}}function Ve(t){if((t=t.__)!=null&&t.__c!=null)return t.__e=t.__c.base=null,t.__k.some(function(e){if(e!=null&&e.__e!=null)return t.__e=t.__c.base=e.__e}),Ve(t)}function ze(t){(!t.__d&&(t.__d=!0)&&z.push(t)&&!ae.__r++||je!=C.debounceRendering)&&((je=C.debounceRendering)||Ge)(ae)}function ae(){try{for(var t,e=1;z.length;)z.length>e&&z.sort(Qe),t=z.shift(),e=z.length,$t(t)}finally{z.length=ae.__r=0}}function Ke(t,e,n,r,i,o,a,d,u,l,f){var s,h,p,x,S,_,b,v=r&&r.__k||oe,L=e.length;for(u=qt(n,e,v,u,L),s=0;s<L;s++)(p=n.__k[s])!=null&&(h=p.__i!=-1&&v[p.__i]||ie,p.__i=s,_=we(t,p,h,i,o,a,d,u,l,f),x=p.__e,p.ref&&h.ref!=p.ref&&(h.ref&&Ie(h.ref,null,p),f.push(p.ref,p.__c||x,p)),S==null&&x!=null&&(S=x),(b=!!(4&p.__u))||h.__k===p.__k?(u=Ye(p,u,t,b),b&&h.__e&&(h.__e=null)):typeof p.type=="function"&&_!==void 0?u=_:x&&(u=x.nextSibling),p.__u&=-7);return n.__e=S,u}function qt(t,e,n,r,i){var o,a,d,u,l,f=n.length,s=f,h=0;for(t.__k=new Array(i),o=0;o<i;o++)(a=e[o])!=null&&typeof a!="boolean"&&typeof a!="function"?(typeof a=="string"||typeof a=="number"||typeof a=="bigint"||a.constructor==String?a=t.__k[o]=ne(null,a,null,null,null):de(a)?a=t.__k[o]=ne(M,{children:a},null,null,null):a.constructor===void 0&&a.__b>0?a=t.__k[o]=ne(a.type,a.props,a.key,a.ref?a.ref:null,a.__v):t.__k[o]=a,u=o+h,a.__=t,a.__b=t.__b+1,d=null,(l=a.__i=Dt(a,n,u,s))!=-1&&(s--,(d=n[l])&&(d.__u|=2)),d==null||d.__v==null?(l==-1&&(i>f?h--:i<f&&h++),typeof a.type!="function"&&(a.__u|=4)):l!=u&&(l==u-1?h--:l==u+1?h++:(l>u?h--:h++,a.__u|=4))):t.__k[o]=null;if(s)for(o=0;o<f;o++)(d=n[o])!=null&&(2&d.__u)==0&&(d.__e==r&&(r=G(d)),Ze(d,d));return r}function Ye(t,e,n,r){var i,o;if(typeof t.type=="function"){for(i=t.__k,o=0;i&&o<i.length;o++)i[o]&&(i[o].__=t,e=Ye(i[o],e,n,r));return e}t.__e!=e&&(r&&(e&&t.type&&!e.parentNode&&(e=G(t)),n.insertBefore(t.__e,e||null)),e=t.__e);do e=e&&e.nextSibling;while(e!=null&&e.nodeType==8);return e}function Dt(t,e,n,r){var i,o,a,d=t.key,u=t.type,l=e[n],f=l!=null&&(2&l.__u)==0;if(l===null&&d==null||f&&d==l.key&&u==l.type)return n;if(r>(f?1:0)){for(i=n-1,o=n+1;i>=0||o<e.length;)if((l=e[a=i>=0?i--:o++])!=null&&(2&l.__u)==0&&d==l.key&&u==l.type)return a}return-1}function Ne(t,e,n){e[0]=="-"?t.setProperty(e,n??""):t[e]=n==null?"":typeof n!="number"||Rt.test(e)?n:n+"px"}function ee(t,e,n,r,i){var o,a;e:if(e=="style")if(typeof n=="string")t.style.cssText=n;else{if(typeof r=="string"&&(t.style.cssText=r=""),r)for(e in r)n&&e in n||Ne(t.style,e,"");if(n)for(e in n)r&&n[e]==r[e]||Ne(t.style,e,n[e])}else if(e[0]=="o"&&e[1]=="n")o=e!=(e=e.replace(We,"$1")),a=e.toLowerCase(),e=a in t||e=="onFocusOut"||e=="onFocusIn"?a.slice(2):e.slice(2),t.l||(t.l={}),t.l[e+o]=n,n?r?n[W]=r[W]:(n[W]=xe,t.addEventListener(e,o?ye:be,o)):t.removeEventListener(e,o?ye:be,o);else{if(i=="http://www.w3.org/2000/svg")e=e.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(e!="width"&&e!="height"&&e!="href"&&e!="list"&&e!="form"&&e!="tabIndex"&&e!="download"&&e!="rowSpan"&&e!="colSpan"&&e!="role"&&e!="popover"&&e in t)try{t[e]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&e[4]!="-"?t.removeAttribute(e):t.setAttribute(e,e=="popover"&&n==1?"":n))}}function Be(t){return function(e){if(this.l){var n=this.l[e.type+t];if(e[te]==null)e[te]=xe++;else if(e[te]<n[W])return;return n(C.event?C.event(e):e)}}}function we(t,e,n,r,i,o,a,d,u,l){var f,s,h,p,x,S,_,b,v,L,D,m,P,$,O,y=e.type;if(e.constructor!==void 0)return null;128&n.__u&&(u=!!(32&n.__u),o=[d=e.__e=n.__e]),(f=C.__b)&&f(e);e:if(typeof y=="function")try{if(b=e.props,v=y.prototype&&y.prototype.render,L=(f=y.contextType)&&r[f.__c],D=f?L?L.props.value:f.__:r,n.__c?_=(s=e.__c=n.__c).__=s.__E:(v?e.__c=s=new y(b,D):(e.__c=s=new re(b,D),s.constructor=y,s.render=Ut),L&&L.sub(s),s.state||(s.state={}),s.__n=r,h=s.__d=!0,s.__h=[],s._sb=[]),v&&s.__s==null&&(s.__s=s.state),v&&y.getDerivedStateFromProps!=null&&(s.__s==s.state&&(s.__s=H({},s.__s)),H(s.__s,y.getDerivedStateFromProps(b,s.__s))),p=s.props,x=s.state,s.__v=e,h)v&&y.getDerivedStateFromProps==null&&s.componentWillMount!=null&&s.componentWillMount(),v&&s.componentDidMount!=null&&s.__h.push(s.componentDidMount);else{if(v&&y.getDerivedStateFromProps==null&&b!==p&&s.componentWillReceiveProps!=null&&s.componentWillReceiveProps(b,D),e.__v==n.__v||!s.__e&&s.shouldComponentUpdate!=null&&s.shouldComponentUpdate(b,s.__s,D)===!1){e.__v!=n.__v&&(s.props=b,s.state=s.__s,s.__d=!1),e.__e=n.__e,e.__k=n.__k,e.__k.some(function(E){E&&(E.__=e)}),oe.push.apply(s.__h,s._sb),s._sb=[],s.__h.length&&a.push(s);break e}s.componentWillUpdate!=null&&s.componentWillUpdate(b,s.__s,D),v&&s.componentDidUpdate!=null&&s.__h.push(function(){s.componentDidUpdate(p,x,S)})}if(s.context=D,s.props=b,s.__P=t,s.__e=!1,m=C.__r,P=0,v)s.state=s.__s,s.__d=!1,m&&m(e),f=s.render(s.props,s.state,s.context),oe.push.apply(s.__h,s._sb),s._sb=[];else do s.__d=!1,m&&m(e),f=s.render(s.props,s.state,s.context),s.state=s.__s;while(s.__d&&++P<25);s.state=s.__s,s.getChildContext!=null&&(r=H(H({},r),s.getChildContext())),v&&!h&&s.getSnapshotBeforeUpdate!=null&&(S=s.getSnapshotBeforeUpdate(p,x)),$=f!=null&&f.type===M&&f.key==null?Xe(f.props.children):f,d=Ke(t,de($)?$:[$],e,n,r,i,o,a,d,u,l),s.base=e.__e,e.__u&=-161,s.__h.length&&a.push(s),_&&(s.__E=s.__=null)}catch(E){if(e.__v=null,u||o!=null)if(E.then){for(e.__u|=u?160:128;d&&d.nodeType==8&&d.nextSibling;)d=d.nextSibling;o[o.indexOf(d)]=null,e.__e=d}else{for(O=o.length;O--;)Ce(o[O]);ve(e)}else e.__e=n.__e,e.__k=n.__k,E.then||ve(e);C.__e(E,e,n)}else o==null&&e.__v==n.__v?(e.__k=n.__k,e.__e=n.__e):d=e.__e=Mt(n.__e,e,n,r,i,o,a,u,l);return(f=C.diffed)&&f(e),128&e.__u?void 0:d}function ve(t){t&&(t.__c&&(t.__c.__e=!0),t.__k&&t.__k.some(ve))}function Je(t,e,n){for(var r=0;r<n.length;r++)Ie(n[r],n[++r],n[++r]);C.__c&&C.__c(e,t),t.some(function(i){try{t=i.__h,i.__h=[],t.some(function(o){o.call(i)})}catch(o){C.__e(o,i.__v)}})}function Xe(t){return typeof t!="object"||t==null||t.__b>0?t:de(t)?t.map(Xe):t.constructor!==void 0?null:H({},t)}function Mt(t,e,n,r,i,o,a,d,u){var l,f,s,h,p,x,S,_=n.props||ie,b=e.props,v=e.type;if(v=="svg"?i="http://www.w3.org/2000/svg":v=="math"?i="http://www.w3.org/1998/Math/MathML":i||(i="http://www.w3.org/1999/xhtml"),o!=null){for(l=0;l<o.length;l++)if((p=o[l])&&"setAttribute"in p==!!v&&(v?p.localName==v:p.nodeType==3)){t=p,o[l]=null;break}}if(t==null){if(v==null)return document.createTextNode(b);t=document.createElementNS(i,v,b.is&&b),d&&(C.__m&&C.__m(e,o),d=!1),o=null}if(v==null)_===b||d&&t.data==b||(t.data=b);else{if(o=v=="textarea"&&b.defaultValue!=null?null:o&&se.call(t.childNodes),!d&&o!=null)for(_={},l=0;l<t.attributes.length;l++)_[(p=t.attributes[l]).name]=p.value;for(l in _)p=_[l],l=="dangerouslySetInnerHTML"?s=p:l=="children"||l in b||l=="value"&&"defaultValue"in b||l=="checked"&&"defaultChecked"in b||ee(t,l,null,p,i);for(l in b)p=b[l],l=="children"?h=p:l=="dangerouslySetInnerHTML"?f=p:l=="value"?x=p:l=="checked"?S=p:d&&typeof p!="function"||_[l]===p||ee(t,l,p,_[l],i);if(f)d||s&&(f.__html==s.__html||f.__html==t.innerHTML)||(t.innerHTML=f.__html),e.__k=[];else if(s&&(t.innerHTML=""),Ke(e.type=="template"?t.content:t,de(h)?h:[h],e,n,r,v=="foreignObject"?"http://www.w3.org/1999/xhtml":i,o,a,o?o[0]:n.__k&&G(n,0),d,u),o!=null)for(l=o.length;l--;)Ce(o[l]);d&&v!="textarea"||(l="value",v=="progress"&&x==null?t.removeAttribute("value"):x!=null&&(x!==t[l]||v=="progress"&&!x||v=="option"&&x!=_[l])&&ee(t,l,x,_[l],i),l="checked",S!=null&&S!=t[l]&&ee(t,l,S,_[l],i))}return t}function Ie(t,e,n){try{if(typeof t=="function"){var r=typeof t.__u=="function";r&&t.__u(),r&&e==null||(t.__u=t(e))}else t.current=e}catch(i){C.__e(i,n)}}function Ze(t,e,n){var r,i;if(C.unmount&&C.unmount(t),(r=t.ref)&&(r.current&&r.current!=t.__e||Ie(r,null,e)),(r=t.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(o){C.__e(o,e)}r.base=r.__P=null}if(r=t.__k)for(i=0;i<r.length;i++)r[i]&&Ze(r[i],e,n||typeof t.type!="function");n||Ce(t.__e),t.__c=t.__=t.__e=void 0}function Ut(t,e,n){return this.constructor(t,n)}function j(t,e,n){var r,i,o,a;e==document&&(e=document.documentElement),C.__&&C.__(t,e),i=(r=typeof n=="function")?null:n&&n.__k||e.__k,o=[],a=[],we(e,t=(!r&&n||e).__k=U(M,null,[t]),i||ie,ie,e.namespaceURI,!r&&n?[n]:i?null:e.firstChild?se.call(e.childNodes):null,o,!r&&n?n:i?i.__e:e.firstChild,r,a),Je(o,t,a)}se=oe.slice,C={__e:function(t,e,n,r){for(var i,o,a;e=e.__;)if((i=e.__c)&&!i.__)try{if((o=i.constructor)&&o.getDerivedStateFromError!=null&&(i.setState(o.getDerivedStateFromError(t)),a=i.__d),i.componentDidCatch!=null&&(i.componentDidCatch(t,r||{}),a=i.__d),a)return i.__E=i}catch(d){t=d}throw t}},Fe=0,Pt=function(t){return t!=null&&t.constructor===void 0},re.prototype.setState=function(t,e){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=H({},this.state),typeof t=="function"&&(t=t(H({},n),this.props)),t&&H(n,t),t!=null&&this.__v&&(e&&this._sb.push(e),ze(this))},re.prototype.forceUpdate=function(t){this.__v&&(this.__e=!0,t&&this.__h.push(t),ze(this))},re.prototype.render=M,z=[],Ge=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Qe=function(t,e){return t.__v.__b-e.__v.__b},ae.__r=0,he=Math.random().toString(8),te="__d"+he,W="__a"+he,We=/(PointerCapture)$|Capture$/i,xe=0,be=Be(!1),ye=Be(!0),Lt=0;var V,A,ke,et,Se=0,dt=[],T=C,tt=T.__b,nt=T.__r,rt=T.diffed,it=T.__c,ot=T.unmount,at=T.__;function Ae(t,e){T.__h&&T.__h(A,t,Se||e),Se=0;var n=A.__H||(A.__H={__:[],__h:[]});return t>=n.__.length&&n.__.push({}),n.__[t]}function q(t){return Se=1,Ot(pt,t)}function Ot(t,e,n){var r=Ae(V++,2);if(r.t=t,!r.__c&&(r.__=[n?n(e):pt(void 0,e),function(d){var u=r.__N?r.__N[0]:r.__[0],l=r.t(u,d);u!==l&&(r.__N=[l,r.__[1]],r.__c.setState({}))}],r.__c=A,!A.__f)){var i=function(d,u,l){if(!r.__c.__H)return!0;var f=r.__c.__H.__.filter(function(h){return h.__c});if(f.every(function(h){return!h.__N}))return!o||o.call(this,d,u,l);var s=r.__c.props!==d;return f.some(function(h){if(h.__N){var p=h.__[0];h.__=h.__N,h.__N=void 0,p!==h.__[0]&&(s=!0)}}),o&&o.call(this,d,u,l)||s};A.__f=!0;var o=A.shouldComponentUpdate,a=A.componentWillUpdate;A.componentWillUpdate=function(d,u,l){if(this.__e){var f=o;o=void 0,i(d,u,l),o=f}a&&a.call(this,d,u,l)},A.shouldComponentUpdate=i}return r.__N||r.__}function ce(t,e){var n=Ae(V++,3);!T.__s&&ct(n.__H,e)&&(n.__=t,n.u=e,A.__H.__h.push(n))}function lt(t,e){var n=Ae(V++,7);return ct(n.__H,e)&&(n.__=t(),n.__H=e,n.__h=t),n.__}function Ht(){for(var t;t=dt.shift();){var e=t.__H;if(t.__P&&e)try{e.__h.some(le),e.__h.some(Ee),e.__h=[]}catch(n){e.__h=[],T.__e(n,t.__v)}}}T.__b=function(t){A=null,tt&&tt(t)},T.__=function(t,e){t&&e.__k&&e.__k.__m&&(t.__m=e.__k.__m),at&&at(t,e)},T.__r=function(t){nt&&nt(t),V=0;var e=(A=t.__c).__H;e&&(ke===A?(e.__h=[],A.__h=[],e.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(e.__h.some(le),e.__h.some(Ee),e.__h=[],V=0)),ke=A},T.diffed=function(t){rt&&rt(t);var e=t.__c;e&&e.__H&&(e.__H.__h.length&&(dt.push(e)!==1&&et===T.requestAnimationFrame||((et=T.requestAnimationFrame)||jt)(Ht)),e.__H.__.some(function(n){n.u&&(n.__H=n.u),n.u=void 0})),ke=A=null},T.__c=function(t,e){e.some(function(n){try{n.__h.some(le),n.__h=n.__h.filter(function(r){return!r.__||Ee(r)})}catch(r){e.some(function(i){i.__h&&(i.__h=[])}),e=[],T.__e(r,n.__v)}}),it&&it(t,e)},T.unmount=function(t){ot&&ot(t);var e,n=t.__c;n&&n.__H&&(n.__H.__.some(function(r){try{le(r)}catch(i){e=i}}),n.__H=void 0,e&&T.__e(e,n.__v))};var st=typeof requestAnimationFrame=="function";function jt(t){var e,n=function(){clearTimeout(r),st&&cancelAnimationFrame(e),setTimeout(t)},r=setTimeout(n,35);st&&(e=requestAnimationFrame(n))}function le(t){var e=A,n=t.__c;typeof n=="function"&&(t.__c=void 0,n()),A=e}function Ee(t){var e=A;t.__c=t.__(),A=e}function ct(t,e){return!t||t.length!==e.length||e.some(function(n,r){return n!==t[r]})}function pt(t,e){return typeof e=="function"?e(t):e}var zt=0;function c(t,e,n,r,i,o){e||(e={});var a,d,u=e;if("ref"in u)for(d in u={},e)d=="ref"?a=e[d]:u[d]=e[d];var l={type:t,props:u,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--zt,__i:-1,__u:0,__source:i,__self:o};if(typeof t=="function"&&(a=t.defaultProps))for(d in a)u[d]===void 0&&(u[d]=a[d]);return C.vnode&&C.vnode(l),l}var Nt=`
.pe-slider-overlay {
...
`;function Bt(){if(document.getElementById("pe-slider-styles"))return;let t=document.createElement("style");t.id="pe-slider-styles",t.textContent=Nt,document.head.appendChild(t)}function Ft({payload:t,sessionId:e,onClose:n,onConfirm:r}){let[i,o]=q(new Set(t.selectableGifts.filter(p=>p.isSelected).map(p=>p.variantId))),[a,d]=q(!1),u=t.maxSelectableCount-t.alreadySelectedCount,l=i.size<u;function f(p){if(!p.isAvailable)return;let x=new Set(i);x.has(p.variantId)?x.delete(p.variantId):l&&x.add(p.variantId),o(x)}async function s(){d(!0);try{await r([...i]),k("promo_engine:gift_selected",{offer_id:t.offerId,variant_ids:[...i],session_id:e}),n()}finally{d(!1)}}function h(p){p.target.classList.contains("pe-slider-overlay")&&n()}return ce(()=>{let p=x=>{x.key==="Escape"&&n()};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[n]),c("div",{class:"pe-slider-overlay",onClick:h,role:"dialog","aria-modal":"true",children:c("div",{class:"pe-slider-modal",children:[c("div",{class:"pe-slider-header",children:[c("div",{children:[c("h2",{class:"pe-slider-title",children:t.title}),t.subtitle&&c("p",{class:"pe-slider-subtitle",children:t.subtitle})]}),c("button",{class:"pe-slider-close",onClick:n,"aria-label":"Close gift selection",children:"\u2715"})]}),c("div",{class:"pe-slider-body",children:c("div",{class:"pe-gift-grid",children:t.selectableGifts.map(p=>{let x=i.has(p.variantId),S=!p.isAvailable;return c("div",{class:`pe-gift-card${x?" pe-selected":""}${S?" pe-unavailable":""}`,onClick:()=>f(p),role:"checkbox","aria-checked":x,"aria-disabled":S,tabIndex:S?-1:0,onKeyDown:_=>{(_.key==="Enter"||_.key===" ")&&(_.preventDefault(),f(p))},children:[x&&c("span",{class:"pe-gift-check","aria-hidden":"true",children:"\u2713"}),p.imageUrl?c("img",{class:"pe-gift-img",src:p.imageUrl,alt:p.title,loading:"lazy",width:160,height:160}):c("div",{class:"pe-gift-img-placeholder","aria-hidden":"true"}),c("p",{class:"pe-gift-name",children:p.title}),p.variantTitle&&c("p",{class:"pe-gift-variant",children:p.variantTitle}),c("p",{class:"pe-gift-price",children:p.discountedPriceCents===0?c("span",{class:"pe-gift-free",children:"Free"}):c(M,{children:[c("s",{children:["$",(p.originalPriceCents/100).toFixed(2)]})," ",c("span",{class:"pe-gift-free",children:["$",(p.discountedPriceCents/100).toFixed(2)]})]})}),S&&c("p",{style:{fontSize:"11px",color:"#ef4444",marginTop:"4px"},children:"Out of stock"})]},p.variantId)})})}),c("div",{class:"pe-slider-footer",children:[c("p",{class:"pe-selected-count",children:[i.size," / ",u," selected"]}),c("button",{class:"pe-btn-confirm",onClick:s,disabled:i.size===0||a,children:a?c("span",{class:"pe-spinner",style:{display:"inline-block"}}):`Add ${i.size>0?i.size:""} Gift${i.size!==1?"s":""} to Cart`})]})]})})}var N=null;function ut(t,e){Bt(),N||(N=document.createElement("div"),N.id="pe-gift-slider-root",document.body.appendChild(N)),j(U(Ft,{payload:t,sessionId:e,onClose:()=>{N&&(j(U(M,null),N),w(g.GiftSliderClosed),k("promo_engine:gift_slider_opened",{offer_id:t.offerId,session_id:e}))},onConfirm:async i=>{let a=(await R.getCart()).items.filter(d=>d.properties._promo_engine_offer_id===t.offerId);for(let d of a)i.includes(String(d.variant_id))||await R.removeLine({key:d.key});for(let d of i)if(!a.some(l=>String(l.variant_id)===d)){let l=t.selectableGifts.find(f=>f.variantId===d);await R.addLines([{variantId:d,quantity:1,properties:{_promo_engine_line_type:"gift",_promo_engine_offer_id:t.offerId,_promo_engine_reward_id:l?.variantId??d,_promo_engine_offer_version:"1",_promo_engine_hash:""}}])}w(g.CartChanged)}}),N),k("promo_engine:gift_slider_opened",{offer_id:t.offerId,session_id:e})}function ft(t){I(g.EvaluationCompleted,e=>{e.giftSlider&&Array.isArray(e.giftSlider.selectableGifts)&&ut(e.giftSlider,t)}),I(g.GiftSliderRequested,e=>{ut(e,t)})}var Gt=`
...
`;function K(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Qt({config:t,currency:e,sessionId:n}){let[r,i]=q(new Set([t.mainProduct.variantId,...t.relatedProducts.slice(0,2).map(_=>_.variantId)])),[o,a]=q(!1),[d,u]=q(!1),l=[t.mainProduct,...t.relatedProducts.slice(0,t.maxProducts-1)],f=l.filter(_=>r.has(_.variantId)),s=f.reduce((_,b)=>_+b.discountedPriceCents,0),p=f.reduce((_,b)=>_+b.priceCents,0)-s;function x(_){if(_===t.mainProduct.variantId)return;let b=new Set(r);b.has(_)?b.delete(_):b.add(_),i(b)}async function S(){if(!(o||f.length===0)){a(!0);try{await R.addLines(f.map(_=>({variantId:_.variantId,quantity:1,properties:{_promo_engine_line_type:"upsell",_promo_engine_offer_id:t.offerId}}))),u(!0),w(g.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,widget_type:"fbt",variant_ids:[...r],session_id:n})}finally{a(!1)}}}return ce(()=>{k("promo_engine:widget_viewed",{offer_id:t.offerId,widget_type:"fbt",session_id:n})},[]),d?c("div",{class:"pe-fbt",children:c("p",{class:"pe-fbt-added",children:["\u2713 Added ",f.length," item(s) to cart!"]})}):c("div",{class:"pe-fbt",children:[c("h3",{class:"pe-fbt-title",children:t.title||"Frequently Bought Together"}),c("div",{class:"pe-fbt-products",children:l.map((_,b)=>{let v=r.has(_.variantId),L=_.variantId===t.mainProduct.variantId;return c(M,{children:[b>0&&c("span",{class:"pe-fbt-plus","aria-hidden":"true",children:"+"}),c("div",{class:`pe-fbt-product${v?" pe-selected":""}`,onClick:()=>x(_.variantId),role:"checkbox","aria-checked":v,tabIndex:L?-1:0,onKeyDown:D=>{(D.key===" "||D.key==="Enter")&&(D.preventDefault(),x(_.variantId))},children:[c("input",{type:"checkbox",class:"pe-fbt-check",checked:v,disabled:L,"aria-hidden":"true",tabIndex:-1,readOnly:!0}),_.imageUrl?c("img",{class:"pe-fbt-img",src:_.imageUrl,alt:_.title,loading:"lazy"}):c("div",{class:"pe-fbt-img-ph","aria-hidden":"true"}),c("div",{class:"pe-fbt-info",children:[c("p",{class:"pe-fbt-name",children:_.title}),_.variantTitle&&c("p",{class:"pe-fbt-price",children:_.variantTitle}),c("p",{class:"pe-fbt-price",children:_.discountedPriceCents<_.priceCents?c("span",{class:"pe-fbt-price-disc",children:K(_.discountedPriceCents,e)}):K(_.priceCents,e)})]})]},_.variantId)]})})}),c("div",{class:"pe-fbt-summary",children:[c("p",{class:"pe-fbt-total",children:["Total: ",c("strong",{children:K(s,e)}),p>0&&c(M,{children:[" ",c("span",{class:"pe-fbt-price-disc",children:["(save ",K(p,e),")"]})]})]}),c("button",{class:"pe-fbt-btn",onClick:S,disabled:o||f.length===0,"aria-label":`Add ${f.length} item(s) to cart for ${K(s,e)}`,children:o?"Adding\u2026":t.buttonText||`Add ${f.length} to Cart`})]})]})}function _t(t,e,n,r){if(!document.getElementById("pe-fbt-styles")){let i=document.createElement("style");i.id="pe-fbt-styles",i.textContent=Gt,document.head.appendChild(i)}j(U(Qt,{config:e,currency:n,sessionId:r}),t)}var Wt={position:"bottom_right",style:"icon_title",primaryColor:"#111",iconSizeRem:3.5},Vt=`
.pe-today-wrap {
...
`;function Kt({items:t,config:e,sessionId:n}){let[r,i]=q(!1);if(t.length===0)return null;let o=e.position==="bottom_left"?"pe-left":"pe-right";function a(d){if(k("promo_engine:widget_clicked",{offer_id:d.offerId,widget_type:"today_offer",session_id:n}),d.redirectUrl)try{let u=new URL(d.redirectUrl,window.location.href);if(u.protocol==="http:"||u.protocol==="https:"){window.location.href=u.href;return}}catch{}i(!1)}return c("div",{class:`pe-today-wrap ${o}`,style:{"--pe-primary":e.primaryColor},children:[r&&c("div",{class:"pe-today-panel",role:"dialog","aria-label":"Today's offers",children:[c("div",{class:"pe-today-panel-header",children:[c("h3",{class:"pe-today-panel-title",children:"Today's Offers"}),c("button",{class:"pe-today-close",onClick:()=>i(!1),"aria-label":"Close",children:"\u2715"})]}),c("div",{class:"pe-today-offers",children:t.map(d=>c("div",{class:"pe-today-offer-item",onClick:()=>a(d),role:"button",tabIndex:0,onKeyDown:u=>{u.key==="Enter"&&a(d)},children:[d.imageUrl?c("img",{class:"pe-today-offer-img",src:d.imageUrl,alt:d.title,loading:"lazy"}):c("div",{class:"pe-today-offer-img","aria-hidden":"true",children:"\u{1F381}"}),c("div",{class:"pe-today-offer-info",children:[c("p",{class:"pe-today-offer-title",children:d.title}),d.description&&c("p",{class:"pe-today-offer-desc",children:d.description})]}),c("span",{class:"pe-today-offer-btn",children:d.buttonText||"View \u2192"})]},d.offerId))})]}),c("button",{class:"pe-today-trigger",onClick:()=>{i(d=>!d),r||k("promo_engine:widget_viewed",{widget_type:"today_offer",offer_count:t.length,session_id:n})},"aria-expanded":r,"aria-haspopup":"dialog","aria-label":`${t.length} offer${t.length!==1?"s":""} available`,children:[c("span",{class:"pe-today-icon","aria-hidden":"true",children:"\u{1F381}"}),e.style==="icon_title"&&c("span",{children:"Today's Deals"}),c("span",{class:"pe-today-dot","aria-hidden":"true"})]})]})}var Y=null;function mt(t,e){let n={...Wt,...t};if(!document.getElementById("pe-today-styles")){let r=document.createElement("style");r.id="pe-today-styles",r.textContent=Vt,document.head.appendChild(r)}Y||(Y=document.createElement("div"),Y.id="pe-today-offer-root",document.body.appendChild(Y)),I(g.EvaluationCompleted,r=>{let i=(Array.isArray(r.qualifiedOffers)?r.qualifiedOffers:[]).map(o=>({offerId:o.offerId,title:o.type+" offer",description:"",imageUrl:null,buttonText:"View",redirectUrl:null,badgeText:null}));j(U(Kt,{items:i,config:n,sessionId:e}),Y)})}function gt(t,e){return new Intl.NumberFormat(navigator.language,{style:"currency",currency:e}).format(t/100)}function Yt(t,e){return[...e].sort((n,r)=>r.minQuantity-n.minQuantity).find(n=>t>=n.minQuantity)??null}function Jt({config:t,sessionId:e}){let[n,r]=q(0),[i,o]=q(new Map),[a,d]=q(""),u="name_asc",[l,f]=q(!1),[s,h]=q(!1),p=t.layoutMode==="one_step_per_page",x=p?[t.steps[n]].filter(Boolean):t.steps,S=lt(()=>{let m=0;for(let P of i.values())for(let $ of P.values())m+=$;return m},[i]),_=Yt(S,t.tiers);function b(m,P,$){o(O=>{let y=new Map(O),E=new Map(y.get(m)??[]);return $===0?E.delete(P):E.set(P,$),y.set(m,E),y})}function v(m){return[...i.get(m)?.values()??[]].reduce((P,$)=>P+$,0)}function L(m){let P=v(m.id);return P>=m.minQuantity&&(m.maxQuantity===null||P<=m.maxQuantity)}async function D(){if(!l){f(!0);try{let m=[];for(let[P,$]of i.entries())for(let[O,y]of $.entries())m.push({variantId:O,quantity:y,properties:{_promo_engine_line_type:"bundle_component",_promo_engine_offer_id:t.offerId,_promo_engine_bundle_id:t.bundleId,_promo_engine_bundle_step_id:P,_promo_engine_bundle_title:t.title,_promo_engine_hash:""}});await R.addLines(m),h(!0),w(g.CartChanged),k("promo_engine:bundle_added_to_cart",{offer_id:t.offerId,bundle_id:t.bundleId,total_qty:S,session_id:e})}finally{f(!1)}}}return s?c("div",{class:"pe-bb-success",children:[c("p",{children:"\u2713 Bundle added to cart!"}),c("button",{onClick:()=>h(!1),children:"Build Another"})]}):c("div",{class:"pe-bb",children:[c("h1",{class:"pe-bb-title",children:t.title}),t.description&&c("p",{class:"pe-bb-desc",children:t.description}),t.tiers.length>0&&c("div",{class:"pe-bb-tiers",children:t.tiers.map(m=>c("div",{class:`pe-bb-tier${_?.minQuantity===m.minQuantity?" pe-active":""}`,children:[c("span",{class:"pe-bb-tier-label",children:m.label}),c("span",{class:"pe-bb-tier-qty",children:["Buy ",m.minQuantity,"+"]}),c("span",{class:"pe-bb-tier-discount",children:m.discountType==="percentage"?`-${Math.round(m.discountValue)}%`:gt(m.discountValue,t.currency)})]},m.minQuantity))}),x.map(m=>{let P=v(m.id),$=L(m),O=m.products.filter(y=>!a||y.title.toLowerCase().includes(a.toLowerCase())).sort((y,E)=>u==="price_asc"?y.priceCents-E.priceCents:u==="price_desc"?E.priceCents-y.priceCents:y.title.localeCompare(E.title));return c("div",{class:"pe-bb-step",children:[c("div",{class:"pe-bb-step-header",children:[c("h2",{class:"pe-bb-step-title",children:[p&&`Step ${n+1} of ${t.steps.length}: `,m.title]}),m.subtitle&&c("p",{class:"pe-bb-step-subtitle",children:m.subtitle}),c("p",{class:"pe-bb-step-count",children:[P," selected",m.minQuantity>0&&` (min ${m.minQuantity})`,m.maxQuantity&&` (max ${m.maxQuantity})`,$&&" \u2713"]})]}),m.searchEnabled&&c("input",{class:"pe-bb-search",type:"text",placeholder:"Search products...",value:a,onInput:y=>d(y.target.value),"aria-label":"Search products in this step"}),c("div",{class:"pe-bb-products",children:O.map(y=>{let E=i.get(m.id)?.get(y.variantId)??0,De=m.maxQuantity!==null&&P>=m.maxQuantity&&E===0;return c("div",{class:`pe-bb-product${E>0?" pe-selected":""}${y.isAvailable?"":" pe-unavailable"}${De?" pe-at-max":""}`,children:[y.imageUrl&&c("img",{class:"pe-bb-img",src:y.imageUrl,alt:y.title,loading:"lazy"}),c("p",{class:"pe-bb-product-name",children:y.title}),y.variantTitle&&c("p",{class:"pe-bb-variant",children:y.variantTitle}),c("p",{class:"pe-bb-price",children:gt(y.priceCents,t.currency)}),y.isAvailable?c("div",{class:"pe-bb-qty-ctrl",children:[c("button",{onClick:()=>b(m.id,y.variantId,Math.max(0,E-1)),disabled:E===0,"aria-label":`Remove ${y.title}`,children:"\u2212"}),c("span",{class:"pe-bb-qty",children:E}),c("button",{onClick:()=>b(m.id,y.variantId,E+1),disabled:De,"aria-label":`Add ${y.title}`,children:"+"})]}):c("span",{class:"pe-bb-oos",children:"Out of stock"})]},y.variantId)})})]},m.id)}),c("div",{class:"pe-bb-footer",children:p?c("div",{class:"pe-bb-nav",children:[n>0&&c("button",{class:"pe-bb-btn-prev",onClick:()=>r(m=>m-1),children:"\u2190 Previous"}),n<t.steps.length-1?c("button",{class:"pe-bb-btn-next",onClick:()=>{k("promo_engine:bundle_step_completed",{offer_id:t.offerId,step_index:n,session_id:e}),r(m=>m+1)},disabled:!t.steps[n]||!L(t.steps[n]),children:"Next \u2192"}):c("button",{class:"pe-bb-btn-add",onClick:D,disabled:l||!t.steps.every(m=>L(m)),children:l?"Adding\u2026":`Add Bundle to Cart${_?` (${_.label})`:""}`})]}):c("div",{class:"pe-bb-summary",children:[c("p",{class:"pe-bb-total",children:[S," items selected"]}),_&&c("p",{class:"pe-bb-saving",children:["\u{1F4B0} ",_.label," applied!"]}),c("button",{class:"pe-bb-btn-add",onClick:D,disabled:l||!t.steps.every(m=>L(m)),children:l?"Adding\u2026":"Add Bundle to Cart"})]})})]})}function ht(t,e,n){j(U(Jt,{config:e,sessionId:n}),t)}var Te=class extends HTMLElement{offerId="";widgetId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.widgetId=this.getAttribute("widget-id")??"",this.attachShadow({mode:"open"}),this.renderSkeleton(),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=(Array.isArray(e.progressBars)?e.progressBars:[]).find(r=>r.offerId===this.offerId||r.widgetId===this.widgetId);n&&this.renderPayload(n)})}disconnectedCallback(){this.unsubscribe?.()}renderSkeleton(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
...
`,Le=class extends HTMLElement{offerId="";variantId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.variantId=this.getAttribute("variant-id")??"",this.attachShadow({mode:"open"}),this.render(null),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=Array.isArray(e.qualifiedOffers)?e.qualifiedOffers.find(r=>r.offerId===this.offerId):null;this.render(n?{offerName:"Free Gift Available"}:null)}),I(g.ProductChanged,e=>{this.variantId=e.variantId})}disconnectedCallback(){this.unsubscribe?.()}render(e){if(!this.shadowRoot)return;let n=pe(this.getAttribute("label")??"Free Gift"),r=parseInt(this.getAttribute("countdown-seconds")??"0",10),i=pe(e?.offerName??""),o=pe(this.offerId);this.shadowRoot.innerHTML=`
      <style>${Zt}</style>
    ...
    `,e&&(this.shadowRoot.querySelector(".pe-gift-icon-wrap")?.addEventListener("click",()=>{w(g.GiftSliderRequested,{offerId:this.offerId}),k("promo_engine:widget_clicked",{offer_id:this.offerId,widget_type:"gift_icon"})}),r>0&&this.startCountdown(r))}startCountdown(e){if(!this.shadowRoot)return;let n=e,r=()=>{let i=this.shadowRoot?.getElementById(`cd-${this.offerId}`);if(!i)return;let o=Math.floor(n/60),a=n%60;i.textContent=` (${o}:${String(a).padStart(2,"0")})`,n--,n>=0&&setTimeout(r,1e3)};r()}};customElements.define("promo-gift-icon",Le);var bt=`
:host { display: block; }
.pe-thumb-wrap {
...
`,Re=class extends HTMLElement{offerId="";unsubscribe=null;connectedCallback(){this.offerId=this.getAttribute("offer-id")??"",this.attachShadow({mode:"open"}),this.render(null),this.unsubscribe=I(g.EvaluationCompleted,e=>{let n=Array.isArray(e.qualifiedOffers)?e.qualifiedOffers.find(i=>i.offerId===this.offerId):null,r=e.giftSlider;this.render(n&&r?r.selectableGifts:null)})}disconnectedCallback(){this.unsubscribe?.()}render(e){if(!this.shadowRoot)return;if(!e||e.length===0){this.shadowRoot.innerHTML=`<style>${bt}</style><div class="pe-thumb-wrap pe-hidden"></div>`;return}let r=e.slice(0,4).map(i=>{let o=Xt(i.imageUrl),a=pe(i.title);return o?`<div class="pe-thumb-product">
    ...
    `,this.shadowRoot.querySelector(".pe-thumb-cta")?.addEventListener("click",()=>{w(g.GiftSliderRequested,{offerId:this.offerId})})}};customElements.define("promo-gift-thumbnail",Re);var en=`
:host { display: block; }
...
`,qe=class extends HTMLElement{filterOfferIds=[];unsubscribe=null;connectedCallback(){let e=this.getAttribute("offer-ids");this.filterOfferIds=e?e.split(",").map(n=>n.trim()):[],this.attachShadow({mode:"open"}),this.render([]),this.unsubscribe=I(g.EvaluationCompleted,n=>{let r=Array.isArray(n.qualifiedOffers)?n.qualifiedOffers:[];this.filterOfferIds.length>0&&(r=r.filter(i=>this.filterOfferIds.includes(i.offerId))),this.render(r.map(i=>({offerId:i.offerId,title:i.type,description:"",imageUrl:null,badgeText:"Active"})))})}disconnectedCallback(){this.unsubscribe?.()}render(e){if(!this.shadowRoot)return;let n=J(this.getAttribute("title")??"Today's Offers");if(e.length===0){this.shadowRoot.innerHTML=`<style>${yt}</style><div class="pe-tob-empty"></div>`;return}let r=e.map(i=>{let o=J(i.offerId),a=J(i.title),d=J(i.description),u=J(i.badgeText),l=tn(i.imageUrl);return`
